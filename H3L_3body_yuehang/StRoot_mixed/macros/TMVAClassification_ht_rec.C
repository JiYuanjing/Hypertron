...
void TMVAClassification_ht_rec( int const ptBin = 0,
//               int const centBin = 0,
            TString myMethodList = "" )
{
  ...
  float const PtBins[nPtBins+1] =    {6.0,50.0};
   ...
   // Create a ROOT output file where TMVA will store ntuples, histograms, etc.
    ...
    TFile* outputFile = TFile::Open( Form("output/TMVA_rec_ht_pl_wgt_%d.root",ptBin), "RECREATE" );
   ...
   TString weightBaseName = Form("tmva_rec_ht_weight_kf_pt_%d",ptBin);
...
factory->PrepareTrainingAndTestTree( mycut, 40000, 20000, 20000, 20000,
  ...
  //                                   "nTrain_Signal=0:nTrain_Background=0:SplitMode=Random:NormMode=NumEvents:!V" );
   ...
   if (Use["Cuts"])
      factory->BookMethod( TMVA::Types::kCuts, "Cuts",
                           ...
                           //"!H:!V:FitMethod=MC:EffSel:SampleSize=1000000:VarProp=FSmart" );
