...
void process_tree_tmva_ht_kf_vmv13(int condor=0, int cut_mode=0, int wgt=2, int batch=0, int cut_0=0, int cut_1=0, int cut_2=0, int cut_3=0 , int cut_4=0){
...
strcpy (ofile, Form("run18_3gev_ht_hist_mu_1x_14_newreweight_centa%d_wgt%d_cut%d_%d%d%d%d%d_v13.root",choose_cent,_wgt,_cut_mode,_cut_0,_cut_1,_cut_2,_cut_3,_cut_4));
nChains = 1126;
}
if(_condor==1){//data
