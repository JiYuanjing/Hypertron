...
void process_tree_27_hl_kf_vmv9(int condor=0, int cut_mode=0, int wgt=2, int batch=0){
...
//strcpy (ofile,Form("run18_7gev_hl_hist_pico_loose_8_centa%d_cut%d_v9.root",choose_cent,_cut_mode));
//nChains = 762;

fin.open("/star/u/yhleung2/pwg/33.standard_reco/taxi_ht_27_pico_tree_newpid/filelist.txt");
strcpy (ofile,Form("run18_27gev_hl_hist_pico_loose_8_centa%d_cut%d_v9.root",choose_cent,_cut_mode));
nChains = 8217;
}
        if(_batch==1){
//fin.open("/star/u/yhleung2/pwg/33.standard_reco/taxi_ht_pico_tree_newpid_rotate_0/filelist.txt");
//strcpy (ofile,Form("run18_7gev_hl_hist_pico_rotate_0_loose_7_centa%d_cut%d.root",choose_cent,_cut_mode));

//        fin.open("/star/u/yhleung2/pwg/33.standard_reco/taxi_ht_26p5_pico_tree_newpid_rotate_0/filelist.txt");
//strcpy (ofile,Form("run18_7gev_hl_hist_pico_rotate_0_loose_8_centa%d_cut%d_v9.root",choose_cent,_cut_mode));
//nChains = 767;

fin.open("/star/u/yhleung2/pwg/33.standard_reco/taxi_ht_27_pico_tree_newpid_rotate_0/filelist.txt");
        strcpy (ofile,Form("run18_27gev_hl_hist_pico_rotate_0_loose_8_centa%d_cut%d_v9.root",choose_cent,_cut_mode));
nChains = 8223;
}
        if(_batch==2){
fin.open("/star/u/yhleung2/pwg/33.standard_reco/taxi_ht_pico_tree_newpid2_rotate_1/filelist.txt");
strcpy (ofile,Form("run18_7gev_hl_hist_pico_rotate_1_loose_8_centa%d_cut%d_v9.root",choose_cent,_cut_mode));
nChains = 1219;
}
        if(_batch==3){
fin.open("/star/u/yhleung2/pwg/33.standard_reco/taxi_ht_pico_tree_newpid2_rotate_2/filelist.txt");
strcpy (ofile,Form("run18_7gev_hl_hist_pico_rotate_2_loose_8_centa%d_cut%d_v9.root",choose_cent,_cut_mode));
nChains = 1214;
}
        if(_batch==4){
fin.open("/star/u/yhleung2/pwg/33.standard_reco/taxi_ht_pico_tree_newpid2_rotate_3/filelist.txt");
strcpy (ofile,Form("run18_7gev_hl_hist_pico_rotate_3_loose_8_centa%d_cut%d_v9.root",choose_cent,_cut_mode));
nChains = 1220;
}
        if(_batch==5){
fin.open("/star/u/yhleung2/pwg/33.standard_reco/taxi_ht_pico_tree_newpid2_rotate_4/filelist.txt");
strcpy (ofile,Form("run18_7gev_hl_hist_pico_rotate_4_loose_8_centa%d_cut%d_v9.root",choose_cent,_cut_mode));
nChains = 1221;
}
if(_batch==6){
fin.open("/star/u/yhleung2/pwg/33.standard_reco/taxi_ht_pico_tree_newpid2_rotate_5/filelist.txt");
strcpy (ofile,Form("run18_7gev_hl_hist_pico_rotate_5_loose_8_centa%d_cut%d_v9.root",choose_cent,_cut_mode));
nChains = 1221;
}
if(_batch==7){
fin.open("/star/u/yhleung2/pwg/33.standard_reco/taxi_ht_pico_tree_newpid2_rotate_6/filelist.txt");
strcpy (ofile,Form("run18_7gev_hl_hist_pico_rotate_6_loose_8_centa%d_cut%d_v9.root",choose_cent,_cut_mode));
nChains = 1221;
}
...
void book_histo()
{
  ...
  h_mass_pt = new TH3F("h_mass_pt","",1000,min_mass,max_mass,40,-1.5,1.5,50,0,5);
  h_mass_pl = new TH3F("h_mass_pl","",1000,min_mass,max_mass,40,-1.5,1.5,500,0,100);
...
h_ht_bdt = new TH3F("h_ht_bdt","",10,-3.0,0.0,50,0,5,200,-1.,1.);
  ...
  h_eta = new TH2F("h_eta","",200,-1.5,1.5,100,0,10);
