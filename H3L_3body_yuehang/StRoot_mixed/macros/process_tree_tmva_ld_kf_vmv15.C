...
void process_tree_tmva_ld_kf_vmv15(int condor=0, int cut_mode=0){
...
//strcpy (ofile, Form("run18_3gev_ld_hist_nopid_newreweight_centa%d_v15.root",choose_cent));//const pt weight using levy4
...
fin.open("/star/u/yhleung2/pwg/33.standard_reco/taxi_ld_pico_tree_newdata/filelist.txt");
strcpy (ofile,Form("run18_3gev_ld_hist_pico_loose_v15_fidcut_centa%d.root",choose_cent));
nChains = 1223;

//fin.open("/star/u/yhleung2/pwg/33.standard_reco/taxi_ld_pico_rotate_tree_newdata/filelist.txt");
//strcpy (ofile,Form("run18_3gev_ld_hist_pico_rotate_loose_v15_fidcut_centa%d.root",choose_cent));
//nChains = 1186;
