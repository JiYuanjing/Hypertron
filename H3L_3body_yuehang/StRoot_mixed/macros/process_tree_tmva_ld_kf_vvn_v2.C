...
void process_tree_tmva_ld_kf_vvn_v2(int condor=0, int cut_mode=0){
...
strcpy (ofile, Form("run18_3gev_ld_hist_mu_1x_vn_newreweight_centa%d_cut%d_v2.root",choose_cent,_cut_mode));
nChains = 968;
...
//}
  ...
  if(cent_label==9) continue;//whats that?
...
*/
     ...
     h_mass_pt_wgt->Fill(bparticlemass,bmcrap,sqrt(bmcpx*bmcpx+bmcpy*bmcpy));
...
void book_histo()
{
  ...
  h_mass_pt_fine = new TH3F("h_mass_pt_fine",""  ,1000,1,2,20,-1.0,1.0,50,0,5);
  ...
  h_mass_pt_wgt       = new TH3F("h_mass_pt_wgt"     ,"" ,1000,1,2,20,-1.0,1.0,50,0,5);
  h_mass_pt_fine_wgt  = new TH3F("h_mass_pt_fine_wgt","" ,1000,1,2,20,-1.0,1.0,50,0,5);
  ...
  g_pt_fine            = new TH2F("g_pt_fine","",20,-1.0,1.0,50,0,5);
  g_pt_fine2          = new TH2F("g_pt_fine2","",20,-1.0,1.0,50,0,5);
  g_pt_fine_wgt    = new TH2F("g_pt_fine_wgt","",20,-1.0,1.0,50,0,5);
