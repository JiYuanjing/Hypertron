...
void process_tree_tmva_hl_kf_vmv10(int condor=0, int cut_mode=0, int wgt=2, int batch=0){
...
strcpy (ofile, Form("run18_3gev_hl_hist_mu_1x_8_newreweight_centa%d_wgt%d_cut%d_mve_vmv10.root",choose_cent,_wgt,_cut_mode));
nChains = 1268;
...
h_ht_bdt = new TH3F("h_ht_bdt","",10,-2.0,0.0,50,0,5,200,-1.,1.);
  ...
  g_pt_wgt = new TH2F("g_pt_wgt","",10,-1.0,1.0,50,0,5);
