...
void process_tree_tmva_ld_kf_vvn(int condor=0, int cut_mode=0){
...
fgpt_0 = new TFile("ld_input_mc_fine_v15.root","READ");
...
//private embedding, default
//fin.open("/star/u/yhleung2/pwg/33.standard_reco/taxi_ld_pico_tree_newdata/embedding/filelist.txt");
//strcpy (ofile, Form("run18_3gev_ld_hist_mu_1x_7_newreweight_centa%d_cut%d_v15.root",choose_cent,_cut_mode));
//nChains =968;
...
strcpy (ofile,Form("run18_3gev_ld_hist_pico_rotate_loose_4_centa%d_cut%d.root",choose_cent,_cut_mode));
nChains = 1200;
}
