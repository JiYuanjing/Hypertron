...
void process_tree_tmva_ht_kf_vmv7(int condor=0, int cut_mode=0, int wgt=2){
...
fin.open("/star/u/yhleung2/pwg/33.standard_reco/taxi_ht_mu_6/filelist.txt");
strcpy (ofile, Form("run18_3gev_ht_hist_mu_1x_4_newreweight_centa%d_wgt%d.root",choose_cent,_wgt));
nChains = 393;
}
if(_condor==1){//data
