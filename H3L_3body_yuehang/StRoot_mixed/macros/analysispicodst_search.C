...
*/
bool _isPico;
void analysispicodst_search(TString picolist="filelist_3p85gev_new_test.list",  TString outFileName="test27gev1.root", bool _isPico=true)
{
...
//    StKFParticleInterface::instance()->AddDecayToReconstructionList( 3009);
//    StKFParticleInterface::instance()->AddDecayToReconstructionList(-3009);
