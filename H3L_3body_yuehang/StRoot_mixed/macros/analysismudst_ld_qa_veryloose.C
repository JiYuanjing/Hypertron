...
*/
bool _isPico;
//void analysismudst_ld_qa(TString picolist="filelist_ld_emb4.list",  TString outFileName="test_emb4.root", bool _isPico=false)
void analysismudst_ld_qa_veryloose(TString picolist="filelist_ld_emb4_test.list",  TString outFileName="test_emb4.root", bool _isPico=false)
//void analysismudst(TString picolist="test.list",  TString outFileName="test27gev.root", bool _isPico=false)//REAL DATA ANALYSIS MACRO, _isPico is always true
{
...
//loose
    ...
    //const float b=10.;
    //const float c=10.;     
    //StKFParticleInterface::instance()->SetSecondaryCuts(a,b,c);//(const float sigmaMass = 3.f, const float chi2Topo = 5.f, const float ldl = 10.f)`
