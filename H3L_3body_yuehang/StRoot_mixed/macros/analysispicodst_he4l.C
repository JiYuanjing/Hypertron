...
*/
bool _isPico;
void analysispicodst_he4l(TString picolist="filelist_3gev_newlist.list",  TString outFileName="test27gev1.root", bool _isPico=true)
{
...
//StKFParticleInterface::instance()->AddDecayToReconstructionList( 3122)  ;
  StKFParticleInterface::instance()->AddDecayToReconstructionList( 3004);//lambda0
