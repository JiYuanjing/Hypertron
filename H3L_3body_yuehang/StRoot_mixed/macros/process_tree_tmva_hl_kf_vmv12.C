...
void process_tree_tmva_hl_kf_vmv12(int condor=0, int cut_mode=0, int wgt=2, int batch=0, int cut_0=0, int cut_1=0, int cut_2=0, int cut_3=0, int cut_4=0){
...
strcpy (ofile, Form("run18_3gev_hl_hist_mu_1x_8_newreweight_centa%d_wgt%d_cut%d_%d%d%d%d%d_mve_vmv12.root",choose_cent,_wgt,_cut_mode,_cut_0,_cut_1,_cut_2,_cut_3,_cut_4));
nChains = 1268;

//fin.open("/star/u/yhleung2/pwg/33.standard_reco/taxi_hl_mu_newpid2_manualvtxerr_nohepid/filelist.txt");
//strcpy (ofile, Form("run18_3gev_hl_hist_mu_1x_8_newreweight_centa%d_wgt%d_cut%d_%d%d%d%d%d_mve_nohepid_vmv12.root",choose_cent,_wgt,_cut_mode,_cut_0,_cut_1,_cut_2,_cut_3,_cut_4));
//nChains = 1268;
...
strcpy (ofile,Form("run18_3gev_hl_hist_pico_loose_8_centa%d_cut%d_%d%d%d%d%d_v12.root",choose_cent,_cut_mode,_cut_0,_cut_1,_cut_2,_cut_3,_cut_4));
nChains = 1222;
//nChains = 10;
}
        if(_batch==1){
...
strcpy (ofile,Form("run18_3gev_hl_hist_pico_rotate_0_loose_8_centa%d_cut%d_%d%d%d%d%d_v12.root",choose_cent,_cut_mode,_cut_0,_cut_1,_cut_2,_cut_3,_cut_4));
nChains = 1208;
//nChains = 10;
}
        if(_batch==2){
fin.open("/star/u/yhleung2/pwg/33.standard_reco/taxi_ht_pico_tree_newpid2_rotate_1/filelist.txt");
strcpy (ofile,Form("run18_3gev_hl_hist_pico_rotate_1_loose_8_centa%d_cut%d_%d%d%d%d%d_v12.root",choose_cent,_cut_mode,_cut_0,_cut_1,_cut_2,_cut_3,_cut_4));
nChains = 1219;
//nChains = 10;
}
        if(_batch==3){
fin.open("/star/u/yhleung2/pwg/33.standard_reco/taxi_ht_pico_tree_newpid2_rotate_2/filelist.txt");
strcpy (ofile,Form("run18_3gev_hl_hist_pico_rotate_2_loose_8_centa%d_cut%d_%d%d%d%d%d_v12.root",choose_cent,_cut_mode,_cut_0,_cut_1,_cut_2,_cut_3,_cut_4));
nChains = 1214;
//nChains = 10;
}
        if(_batch==4){
fin.open("/star/u/yhleung2/pwg/33.standard_reco/taxi_ht_pico_tree_newpid2_rotate_3/filelist.txt");
strcpy (ofile,Form("run18_3gev_hl_hist_pico_rotate_3_loose_8_centa%d_cut%d_%d%d%d%d%d_v12.root",choose_cent,_cut_mode,_cut_0,_cut_1,_cut_2,_cut_3,_cut_4));
nChains = 1220;
}
        if(_batch==5){
fin.open("/star/u/yhleung2/pwg/33.standard_reco/taxi_ht_pico_tree_newpid2_rotate_4/filelist.txt");
strcpy (ofile,Form("run18_3gev_hl_hist_pico_rotate_4_loose_8_centa%d_cut%d_%d%d%d%d%d_v12.root",choose_cent,_cut_mode,_cut_0,_cut_1,_cut_2,_cut_3,_cut_4));
nChains = 1221;
}
if(_batch==6){
fin.open("/star/u/yhleung2/pwg/33.standard_reco/taxi_ht_pico_tree_newpid2_rotate_5/filelist.txt");
strcpy (ofile,Form("run18_3gev_hl_hist_pico_rotate_5_loose_8_centa%d_cut%d_%d%d%d%d%d_v12.root",choose_cent,_cut_mode,_cut_0,_cut_1,_cut_2,_cut_3,_cut_4));
nChains = 1221;
}
if(_batch==7){
fin.open("/star/u/yhleung2/pwg/33.standard_reco/taxi_ht_pico_tree_newpid2_rotate_6/filelist.txt");
strcpy (ofile,Form("run18_3gev_hl_hist_pico_rotate_6_loose_8_centa%d_cut%d_%d%d%d%d%d_v12.root",choose_cent,_cut_mode,_cut_0,_cut_1,_cut_2,_cut_3,_cut_4));
nChains = 1221;
}
