...
void process_tree_tmva_hl_kf_vmv6(int condor=0, int cut_mode=0){
...
strcpy (ofile,Form("run18_3gev_hl_hist_pico_loose_5_centa%d_cut%d.root.root",choose_cent,_cut_mode));
//fin.open("/star/u/yhleung2/pwg/33.standard_reco/taxi_ht_pico_rotate_tree_5/filelist.txt");
//strcpy (ofile,Form("run18_3gev_hl_hist_pico_rotate_loose_5_centa%d_cut%d.root",choose_cent,_cut_mode));
nChains = 1200;
}
...
htriton_tree.SetBranchAddress("bmcx",&bmcx);
htriton_tree.SetBranchAddress("bmcy",&bmcy);
htriton_tree.SetBranchAddress("bmcz",&bmcz);
htriton_tree.SetBranchAddress("bx",&bx);
htriton_tree.SetBranchAddress("by",&by);
htriton_tree.SetBranchAddress("bz",&bz);
}
...
if(_cut_mode>=2){//very loose,scan
ht_chi2topo_cut = 5;
ht_chi2ndf_cut = 5;
//ht_ldl_cut = 3;//loose
//ht_l_cut = 1;//loose
...
h_mass_pt = new TH3F("h_mass_pt","",1000,3.5,4.5,9,-0.9,0.9,50,0,5);
h_mass_pl = new TH3F("h_mass_pl","",1000,3.5,4.5,9,-0.9,0.9,500,0,100);

h_mass_pt_wgt = new TH3F("h_mass_pt_wgt","",1000,3.5,4.5,9,-0.9,0.9,50,0,5);
h_mass_pl_wgt = new TH3F("h_mass_pl_wgt","",1000,3.5,4.5,9,-0.9,0.9,500,0,100);

h_mass_qa = new TH3F("h_mass_qa","",10,-2.0,0.0,50,0,5,1000,3.5,4.5);
