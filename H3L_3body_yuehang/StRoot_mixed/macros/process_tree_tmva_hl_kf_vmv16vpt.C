...
void process_tree_tmva_hl_kf_vmv16vpt(int condor=0, int cut_mode=2, int wgt=4, int batch=0, int cut_0=0, int cut_1=0, int cut_2=0, int cut_3=0, int cut_4=2,int _choose_cent = 1){
...
//strcpy (ofile, Form("run18_3gev_hl_hist_mu_1x_8_newreweight_centa%d_wgt%d_cut%d_%d%d%d%d%d_mve_oldpid_vmv15.root",choose_cent,_wgt,_cut_mode,_cut_0,_cut_1,_cut_2,_cut_3,_cut_4));
//nChains = 1268;

//fin.open("/star/u/yhleung2/pwg/33.standard_reco/taxi_hl_mu_manualvtxerr_newpid/filelist.txt");
//strcpy (ofile, Form("run18_3gev_hl_hist_mu_1x_8_newreweight_centa%d_wgt%d_cut%d_%d%d%d%d%d_mve_newpid_vmv14.root",choose_cent,_wgt,_cut_mode,_cut_0,_cut_1,_cut_2,_cut_3,_cut_4));
//nChains = 1268;

//fin.open("/star/u/yhleung2/pwg/33.standard_reco/taxi_hl_mu_manualvtxerr_nohepid/filelist.txt");
//strcpy (ofile, Form("run18_3gev_hl_hist_mu_1x_8_newreweight_centa%d_wgt%d_cut%d_%d%d%d%d%d_mve_nohepid_vmv14.root",choose_cent,_wgt,_cut_mode,_cut_0,_cut_1,_cut_2,_cut_3,_cut_4));
//nChains = 1268;

//fin.open("/star/u/yhleung2/pwg/33.standard_reco/taxi_hl_mu_manualvtxerr_nohepid_x_3/filelist.txt");
//strcpy (ofile, Form("run18_3gev_hl_hist_mu_1x_8_newreweight_centa%d_wgt%d_cut%d_%d%d%d%d%d_mve_nohepid_vmv14_x.root",choose_cent,_wgt,_cut_mode,_cut_0,_cut_1,_cut_2,_cut_3,_cut_4));
//nChains = 389;


//for ana
//fin.open("/star/u/yhleung2/pwg/33.standard_reco/taxi_hl_mu_manualvtxerr_nohepid_wdedxinfo//filelist.txt");
//strcpy (ofile, Form("run18_3gev_hl_hist_mu_1x_8_newreweight_centa%d_wgt%d_cut%d_%d%d%d%d%d_mve_nohepid_vmv15vpt.root",choose_cent,_wgt,_cut_mode,_cut_0,_cut_1,_cut_2,_cut_3,_cut_4));
//strcpy (ofile, Form("run18_3gev_hl_hist_mu_1x_8_newreweight_centa%d_wgt%d_cut%d_%d%d%d%d%d_mve_nohepid_vmv15vpt_check.root",choose_cent,_wgt,_cut_mode,_cut_0,_cut_1,_cut_2,_cut_3,_cut_4));
//nChains = 1267;


fin.open("/star/u/yhleung2/pwg/33.standard_reco/taxi_hl_mu_manualvtxerr_nohepid_chihe/filelist.txt");
//fin.open("/star/u/yhleung2/pwg/33.standard_reco/taxi_hl_mu_manualvtxerr_nohepid_chihe_off/filelist.txt");
//strcpy (ofile, Form("run18_3gev_hl_hist_mu_1x_8_newreweight_centa%d_wgt%d_cut%d_%d%d%d%d%d_mve_nohepid_vmv16vpt_old.root",choose_cent,_wgt,_cut_mode,_cut_0,_cut_1,_cut_2,_cut_3,_cut_4));
//strcpy (ofile, Form("run18_3gev_hl_hist_mu_1x_8_newreweight_centa%d_wgt%d_cut%d_%d%d%d%d%d_mve_nohepid_vmv16vpt_off2.root",choose_cent,_wgt,_cut_mode,_cut_0,_cut_1,_cut_2,_cut_3,_cut_4));
strcpy (ofile, Form("run18_3gev_hl_hist_mu_1x_8_newreweight_centa%d_wgt%d_cut%d_%d%d%d%d%d_mve_nohepid_vmv16vpt.root",choose_cent,_wgt,_cut_mode,_cut_0,_cut_1,_cut_2,_cut_3,_cut_4));
nChains = 1268;
//nChains = 27;


//fin.open("/star/u/yhleung2/pwg/33.standard_reco/taxi_hl_mu_manualvtxerr_nohepid_chihe_redo/filelist.txt");
//strcpy (ofile, Form("run18_3gev_hl_hist_mu_1x_8_newreweight_centa%d_wgt%d_cut%d_%d%d%d%d%d_mve_nohepid_vmv16vpt_redo2.root",choose_cent,_wgt,_cut_mode,_cut_0,_cut_1,_cut_2,_cut_3,_cut_4));
//nChains = 126;


//fin.open("/star/u/yhleung2/pwg/33.standard_reco/taxi_hl_mu_manualvtxerr_nohepid_chihe_redo/filelist_hl3.txt");
//fin.open("/star/u/yhleung2/pwg/33.standard_reco/taxi_hl_mu_manualvtxerr_nohepid_chihe_off/filelist_off.txt");
//strcpy (ofile,"eff_hl3.root");
//strcpy (ofile,"eff_off.root");
//nChains=1;
...
if(_condor==1){//data
        ...
        if(_batch==0){
//fin.open("/star/u/yhleung2/pwg/33.standard_reco/taxi_ht_pico_tree_newdata/filelist.txt");
fin.open("/star/u/yhleung2/pwg/33.standard_reco/taxi_ht_pico_tree_newdata_chihe/filelist.txt");
strcpy (ofile,Form("run18_3gev_hl_hist_pico_centa%d_cut%d_%d%d%d%d%d_v16vpt.root",choose_cent,_cut_mode,_cut_0,_cut_1,_cut_2,_cut_3,_cut_4));
nChains = 1225;
}
        if(_batch==1){
fin.open("/star/u/yhleung2/pwg/33.standard_reco/taxi_ht_pico_tree_newdata_rotate_0_chihe/filelist.txt");
strcpy (ofile,Form("run18_3gev_hl_hist_pico_rotate_0_centa%d_cut%d_%d%d%d%d%d_v16vpt.root",choose_cent,_cut_mode,_cut_0,_cut_1,_cut_2,_cut_3,_cut_4));
nChains = 1225;

//temporary
//fin.open("/star/u/yhleung2/pwg/33.standard_reco/temp_rotate_filelist.txt");
//strcpy (ofile,Form("run18_3gev_hl_hist_pico_rotate_0_centa%d_cut%d_%d%d%d%d%d_v16vpt.root",choose_cent,_cut_mode,_cut_0,_cut_1,_cut_2,_cut_3,_cut_4));
//nChains = 2403;
}
        if(_batch==2){
fin.open("/star/u/yhleung2/pwg/33.standard_reco/taxi_ht_pico_tree_newdata_rotate_1_chihe/filelist.txt");
strcpy (ofile,Form("run18_3gev_hl_hist_pico_rotate_1_centa%d_cut%d_%d%d%d%d%d_v16vpt.root",choose_cent,_cut_mode,_cut_0,_cut_1,_cut_2,_cut_3,_cut_4));
nChains = 1225;
}
        if(_batch==3){
fin.open("/star/u/yhleung2/pwg/33.standard_reco/taxi_ht_pico_tree_newdata_rotate_2_chihe/filelist.txt");
strcpy (ofile,Form("run18_3gev_hl_hist_pico_rotate_2_centa%d_cut%d_%d%d%d%d%d_v16vpt.root",choose_cent,_cut_mode,_cut_0,_cut_1,_cut_2,_cut_3,_cut_4));
nChains = 1225;
}
        if(_batch==4){
fin.open("/star/u/yhleung2/pwg/33.standard_reco/taxi_ht_pico_tree_newdata_rotate_3_chihe/filelist.txt");
strcpy (ofile,Form("run18_3gev_hl_hist_pico_rotate_3_centa%d_cut%d_%d%d%d%d%d_v16vpt.root",choose_cent,_cut_mode,_cut_0,_cut_1,_cut_2,_cut_3,_cut_4));
nChains = 1224;
}
        if(_batch==5){
fin.open("/star/u/yhleung2/pwg/33.standard_reco/taxi_ht_pico_tree_newdata_rotate_4_chihe/filelist.txt");
strcpy (ofile,Form("run18_3gev_hl_hist_pico_rotate_4_centa%d_cut%d_%d%d%d%d%d_v16vpt.root",choose_cent,_cut_mode,_cut_0,_cut_1,_cut_2,_cut_3,_cut_4));
nChains = 1225;
}
if(_batch==6){
fin.open("/star/u/yhleung2/pwg/33.standard_reco/taxi_ht_pico_tree_newdata_rotate_5_chihe/filelist.txt");
strcpy (ofile,Form("run18_3gev_hl_hist_pico_rotate_5_centa%d_cut%d_%d%d%d%d%d_v16vpt.root",choose_cent,_cut_mode,_cut_0,_cut_1,_cut_2,_cut_3,_cut_4));
nChains = 1224;
}
if(_batch==7){
fin.open("/star/u/yhleung2/pwg/33.standard_reco/taxi_ht_pico_tree_newdata_rotate_6_chihe/filelist.txt");
strcpy (ofile,Form("run18_3gev_hl_hist_pico_rotate_6_centa%d_cut%d_%d%d%d%d%d_v16vpt.root",choose_cent,_cut_mode,_cut_0,_cut_1,_cut_2,_cut_3,_cut_4));
nChains = 1225;
}
...
//        if( (_cut_mode==2 || _cut_mode==3 || _cut_mode==8) && dca_he<dca_he_cut) continue;
        ...
        if(_cut_mode==61 && nhits_pi<25) continue;
        if(_cut_mode==61 && nhits_he<25) continue;
...
//	if(atanh(pz_he/sqrt(px_he*px_he+py_he*py_he+pz_he*pz_he))>-0.3) continue;
  ...
  h_mass_pt = new TH3F("h_mass_pt","",1000,min_mass,max_mass,10,-1.0,1.0,40,0,4);
  ...
  h_mass_pt_wgt = new TH3F("h_mass_pt_wgt","",1000,min_mass,max_mass,10,-1.0,1.0,40,0,4);
...
h_pl_pt_pi = new TH2F("h_pl_pt_pi","",500,0,100,500,0,5);
  ...
  g_pt = new TH2F("g_pt","",10,-1.0,1.0,40,0,4);
  g_pl = new TH2F("g_pl","",10,-1.0,1.0,500,0,100);
  g_pt_fine = new TH2F("g_pt_fine","",10,-1.0,1.0,40,0,4);
  ...
  g_pt_wgt = new TH2F("g_pt_wgt","",10,-1.0,1.0,40,0,4);
