...
void process_tree_tmva_hl_kf_vmv7(int condor=0, int cut_mode=0, int wgt=2){
...
strcpy (ofile, Form("run18_3gev_hl_hist_mu_1x_3_newreweight_centa%d_wgt%d.root",choose_cent,_wgt));
nChains = 262;
}
if(_condor==1){//data
...
strcpy (ofile,Form("run18_3gev_hl_hist_pico_loose_6_centa%d_cut%d.root",choose_cent,_cut_mode));

//fin.open("/star/u/yhleung2/pwg/33.standard_reco/taxi_ht_pico_rotate_tree_5/filelist.txt");
//strcpy (ofile,Form("run18_3gev_hl_hist_pico_rotate_loose_6_centa%d_cut%d.root",choose_cent,_cut_mode));

//fin.open("/star/u/yhleung2/pwg/33.standard_reco/taxi_ht_pico_rotate_tree_7/filelist.txt");
//strcpy (ofile,Form("run18_3gev_hl_hist_pico_rotate_loose_6_centa%d_cut%d_b1.root",choose_cent,_cut_mode));

//fin.open("/star/u/yhleung2/pwg/33.standard_reco/taxi_ht_pico_rotate_tree_7_clone/filelist.txt");
//strcpy (ofile,Form("run18_3gev_hl_hist_pico_rotate_loose_6_centa%d_cut%d_b2.root",choose_cent,_cut_mode));

//fin.open("/star/u/yhleung2/pwg/33.standard_reco/taxi_ht_pico_rotate_tree_7_clone2/filelist.txt");
//strcpy (ofile,Form("run18_3gev_hl_hist_pico_rotate_loose_6_centa%d_cut%d_b3.root",choose_cent,_cut_mode));

//fin.open("/star/u/yhleung2/pwg/33.standard_reco/taxi_ht_pico_rotate_tree_7_clone3/filelist.txt");
//strcpy (ofile,Form("run18_3gev_hl_hist_pico_rotate_loose_6_centa%d_cut%d_b4.root",choose_cent,_cut_mode));
nChains = 1200;
...
//        cout<<"rapwdight:"<<rap_weight<<" "<<pt_weight<<" "<<mc_weight<<endl;
