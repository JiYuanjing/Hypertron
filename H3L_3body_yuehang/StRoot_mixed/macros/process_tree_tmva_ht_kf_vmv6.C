...
void process_tree_tmva_ht_kf_vmv6(int condor=0, int cut_mode=0){
...
h_mass_pt = new TH3F("h_mass_pt","",1000,2.5,3.5,9,-0.9,0.9,50,0,5);
h_mass_pl = new TH3F("h_mass_pl","",1000,2.5,3.5,9,-0.9,0.9,500,0,100);

h_mass_pt_wgt = new TH3F("h_mass_pt_wgt","",1000,2.5,3.5,9,-0.9,0.9,50,0,5);
h_mass_pl_wgt = new TH3F("h_mass_pl_wgt","",1000,2.5,3.5,9,-0.9,0.9,500,0,100);
