...
void process_tree_tmva_hl_kf_vmv9(int condor=0, int cut_mode=0, int wgt=2, int batch=0){
...
strcpy (ofile, Form("run18_3gev_hl_hist_mu_1x_8_newreweight_centa%d_wgt%d_cut%d_mve_v10.root",choose_cent,_wgt,_cut_mode));
nChains = 1268;
