...
void process_tree_tmva_ld_kf_vmv5(int condor=0, int cut_mode=0){
...
fin.open("/star/u/yhleung2/pwg/33.standard_reco/taxi_ld_mu3_correctedvertex_w5xerror_3/sum/filelist.txt");
strcpy (ofile, "run18_3gev_ld_hist_mu_5x_3_newreweight.root");
nChains = 1;
}
if(_condor==1){//data
...
//fin.open("/star/u/yhleung2/pwg/33.standard_reco/taxi_ld_pico_tree_3/filelist.txt");
//strcpy (ofile,"run18_3gev_ld_hist_pico_loose_3.root");
fin.open("/star/u/yhleung2/pwg/33.standard_reco/taxi_ld_pico_rotate_tree_3/filelist.txt");
strcpy (ofile,"run18_3gev_ld_hist_pico_rotate_loose_3.root");
nChains = 1200;
}
