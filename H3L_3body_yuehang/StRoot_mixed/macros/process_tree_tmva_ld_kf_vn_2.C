...
void book_histo();
void write_histo();
void process_tree_tmva_ld_kf_vn_2(int condor=0){
...
if(rap_label_2>=0){ 
  ...
  h_om_mass_phi_2o_eff[cent_cut_label][pt_cut_label][rap_label_2]->Fill(bparticlemass,bphi_evp_2o);
}

if(rap_label>=0){
  h_om_mass_phi_1o[cent_cut_label][pt_cut_label][rap_label]->Fill(bparticlemass,bphi_evp_1o);
  h_om_mass_phi_1o_eff[cent_cut_label][pt_cut_label][rap_label]->Fill(bparticlemass,bphi_evp_1o);
	}
}
