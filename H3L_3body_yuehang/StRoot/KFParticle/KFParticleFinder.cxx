...
//  fNPV(-1),fNThreads(1),fCutCharmPt(0.2f),fCutCharmChiPrim(6.f),fCutLVMPt(0.2f),fCutLVMP(1.0f),fCutJPsiPt(1.0f),
  ...
  fHe4L(0), fHe5L(0),  fLLn(0), fH5LL(0), fPPi(0), fPPibar(0),
...
// #endif
  ...
  if(!fMixedEventAnalysis)
  {
    ...
    FindTrackV0Decay(fPPibar ,-3012, vRTracks[0], 1, vRTracks[0].FirstDeuteron(), vRTracks[0].LastDeuteron(), Particles, PrimVtx, -1, 0);
              ...
              for(int iPDGPos=0; iPDGPos<nPDGPos; iPDGPos++)
              {
                ...
                if(!fMixedEventAnalysis)
                {
                  ...
                  else if(iTC==2)
                  {
                    ...
                    motherPDG( isSecondary && (abs(trackPdgPos[iPDGPos])==       2212) && int_m(abs(trackPdgNeg) ==  211) ) =  3012; //Lambda -> p+ pi-
                  ...
                  else if(iTC==4)
                  {
                    ...
                    motherPDG( isSecondary && (abs(trackPdgPos[iPDGPos])==  211) && int_m(abs(trackPdgNeg) ==       2212) ) =  -3012; //Lambda_bar -> p- pi+
...
//   saveParticle &= ( isCharm && lMin>0.025f ) || !isCharm;
  ...
  for(int iP=0; iP<fNPV; iP++)
  {
    ...
    const float_m isPrimaryPartLocal = ( motherTopoChi2Ndf < cuts[1] ); //std::cout<<"cuts[1]:"<<cuts[1]<<" "<<motherTopoChi2Ndf<<std::endl;
    isPrimaryPart |= isPrimaryPartLocal;
    for(int iV=0; iV<float_vLen; iV++)
    {
      if(isPrimaryPartLocal[iV])
