...
*/
bool _isPico;
void analysispicodst_hn_tree_rotate_0(TString picolist="test.list",  TString outFileName="test27gev1.root", bool _isPico=true)
...
//loose
    ...
    StKFParticleInterface::instance()->SetChiPrimaryCut(0.f);
    //StKFParticleInterface::instance()->SetChiPrimaryCut(3);
    //StKFParticleInterface::instance()->SetChiPrimaryCut2D(3);
    StKFParticleInterface::instance()->SetChiPrimaryCut2D(0.f);
...
//  StKFParticleInterface::instance()->SetChi2CutCharm2D(3);
  ...
  StKFParticleInterface::instance()->AddDecayToReconstructionList(  3103);
...
//  StKFParticleInterface::instance()->AddDecayToReconstructionList(-3334);
  ...
  StKFParticleInterface::instance()->SetRotationAngle(1.*TMath::Pi());
