...
void process_tree_tmva_hl_kf_vmv20(int condor=0, int cut_mode=2, int wgt=4, int batch=0, int cut_0=0, int cut_1=0, int cut_2=0, int cut_3=0, int cut_4=2){
...
bolt0 = new TF1("bolt0", "1e9*x*exp(-(sqrt(3.924*3.924+x*x)-3.924)/[0])", 0.,5);
bolt1 = new TF1("bolt1", "1e9*x*exp(-(sqrt(3.924*3.924+x*x)-3.924)/[0])", 0.,5);
bolt2 = new TF1("bolt2", "1e9*x*exp(-(sqrt(3.924*3.924+x*x)-3.924)/[0])", 0.,5);
...
levyfit8->SetParameters(1.11371e-01 , -2.04689e+08, 4.22255e+07);
        ...
        //t_quadr->SetParameters(1.45231e+00,0,0);//flat
	//t_quadr0->SetParameters(1.45231e+00,0,-2.16912e+00);//reset
//t_quadr0->SetParameters(7.03832e-01,0.,9.60834e-01);//this is from fit to 3gevv data,h4l

        //t_quadr1->SetParameters(1.45231e+00, 0.0,+2.16912e+00);

  t_quadr->SetParameters(1.45231e+00,0, -2.16912e+00+0.5);//
  t_quadr0->SetParameters(1.45231e+00,0,-2.16912e+00);//reset
  t_quadr1->SetParameters(1.45231e+00,0,-2.16912e+00-0.5);//reset


//bolt0->SetParameter(0,0.407);
//bolt1->SetParameter(0,0.398);

	bolt0->SetParameter(0,0.28);
        bolt1->SetParameter(0,0.24);
...
fgpt_0 = new TFile("hl_input_mc_fine_v20.root","READ");
...
strcpy (ofile, Form("run18_3gev_hl_hist_mu_1x_8_newreweight_centa%d_wgt%d_cut%d_%d%d%d%d%d_mve_nohepid_vmv20.root",choose_cent,_wgt,_cut_mode,_cut_0,_cut_1,_cut_2,_cut_3,_cut_4));
nChains = 540;
//nChains = 100;
...
strcpy (ofile,Form("run18_3gev_hl_hist_pico_centa%d_cut%d_%d%d%d%d%d_v20.root",choose_cent,_cut_mode,_cut_0,_cut_1,_cut_2,_cut_3,_cut_4));
nChains = 1225;
}
        if(_batch==1){
        fin.open("/star/u/yhleung2/pwg/33.standard_reco/taxi_ht_pico_tree_newdata_rotate_0_chihe_codata/filelist.txt");
strcpy (ofile,Form("run18_3gev_hl_hist_pico_rotate_0_centa%d_cut%d_%d%d%d%d%d_v20.root",choose_cent,_cut_mode,_cut_0,_cut_1,_cut_2,_cut_3,_cut_4));
nChains = 1225;
}
        if(_batch==2){
        fin.open("/star/u/yhleung2/pwg/33.standard_reco/taxi_ht_pico_tree_newdata_rotate_1_chihe_codata/filelist.txt");
strcpy (ofile,Form("run18_3gev_hl_hist_pico_rotate_1_centa%d_cut%d_%d%d%d%d%d_v20.root",choose_cent,_cut_mode,_cut_0,_cut_1,_cut_2,_cut_3,_cut_4));
nChains = 1221;
}
        if(_batch==3){
        fin.open("/star/u/yhleung2/pwg/33.standard_reco/taxi_ht_pico_tree_newdata_rotate_2_chihe_codata/filelist.txt");
strcpy (ofile,Form("run18_3gev_hl_hist_pico_rotate_2_centa%d_cut%d_%d%d%d%d%d_v20.root",choose_cent,_cut_mode,_cut_0,_cut_1,_cut_2,_cut_3,_cut_4));
nChains = 1225;
}
        if(_batch==4){
        fin.open("/star/u/yhleung2/pwg/33.standard_reco/taxi_ht_pico_tree_newdata_rotate_3_chihe_codata/filelist.txt");
strcpy (ofile,Form("run18_3gev_hl_hist_pico_rotate_3_centa%d_cut%d_%d%d%d%d%d_v20.root",choose_cent,_cut_mode,_cut_0,_cut_1,_cut_2,_cut_3,_cut_4));
nChains = 1225;
}
        if(_batch==5){
        fin.open("/star/u/yhleung2/pwg/33.standard_reco/taxi_ht_pico_tree_newdata_rotate_4_chihe_codata/filelist.txt");
strcpy (ofile,Form("run18_3gev_hl_hist_pico_rotate_4_centa%d_cut%d_%d%d%d%d%d_v20.root",choose_cent,_cut_mode,_cut_0,_cut_1,_cut_2,_cut_3,_cut_4));
nChains = 1225;
}
if(_batch==6){
        fin.open("/star/u/yhleung2/pwg/33.standard_reco/taxi_ht_pico_tree_newdata_rotate_5_chihe_codata/filelist.txt");
strcpy (ofile,Form("run18_3gev_hl_hist_pico_rotate_5_centa%d_cut%d_%d%d%d%d%d_v20.root",choose_cent,_cut_mode,_cut_0,_cut_1,_cut_2,_cut_3,_cut_4));
nChains = 1224;
}
if(_batch==7){
        fin.open("/star/u/yhleung2/pwg/33.standard_reco/taxi_ht_pico_tree_newdata_rotate_6_chihe_codata/filelist.txt");
strcpy (ofile,Form("run18_3gev_hl_hist_pico_rotate_6_centa%d_cut%d_%d%d%d%d%d_v20.root",choose_cent,_cut_mode,_cut_0,_cut_1,_cut_2,_cut_3,_cut_4));
nChains = 1224;
}
...
h_mass_pl->Fill(bparticlemass,brap,ht_pl);
	...
	*/
	...
	float pt_eff_weight;
		...
		rap_weight = t_quadr1->Eval(bmcrap);
		pt_weight =bolt1->Eval(sqrt(bmcpx*bmcpx+bmcpy*bmcpy));
		}else if(_wgt==4){
		rap_weight = t_quadr0->Eval(bmcrap);
		pt_weight =bolt1->Eval(sqrt(bmcpx*bmcpx+bmcpy*bmcpy));
