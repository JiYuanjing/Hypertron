...
void process_tree_tmva_3b_kf_vmv9(int condor=0, int cut_mode=0, int wgt=2, int batch=0){
...
strcpy (ofile, Form("run18_3gev_3b_hist_mu_1x_34_newreweight_centa%d_wgt%d_cut%d_mve.root",choose_cent,_wgt,_cut_mode));
nChains = 255;
}
if(_condor==1){//data
