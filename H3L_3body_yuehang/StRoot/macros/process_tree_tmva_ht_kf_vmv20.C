...
void process_tree_tmva_ht_kf_vmv20(int condor=0, int cut_mode=2, int wgt=4, int batch=0, int cut_0=0, int cut_1=0, int cut_2=0, int cut_3=0, int cut_4=2){
...
//	fin.open("/star/u/yhleung2/pwg/33.standard_reco/taxi_ht_mu_manualvtxerr_nohepid/filelist.txt");
	...
	if(_batch==0){
   	...
   	strcpy (ofile,Form("run18_3gev_ht_hist_pico_centa%d_cut%d_%d%d%d%d%d_v20.root",choose_cent,_cut_mode,_cut_0,_cut_1,_cut_2,_cut_3,_cut_4));
	nChains = 1225;
   	}
	if(_batch==1){
   	fin.open("/star/u/yhleung2/pwg/33.standard_reco/taxi_ht_pico_tree_newdata_rotate_0_chihe_codata/filelist.txt");
   	strcpy (ofile,Form("run18_3gev_ht_hist_pico_rotate_0_centa%d_cut%d_%d%d%d%d%d_v20.root",choose_cent,_cut_mode,_cut_0,_cut_1,_cut_2,_cut_3,_cut_4));
	nChains = 1225;
	}
	if(_batch==2){
	fin.open("/star/u/yhleung2/pwg/33.standard_reco/taxi_ht_pico_tree_newdata_rotate_1_chihe_codata/filelist.txt");
        strcpy (ofile,Form("run18_3gev_ht_hist_pico_rotate_1_centa%d_cut%d_%d%d%d%d%d_v20.root",choose_cent,_cut_mode,_cut_0,_cut_1,_cut_2,_cut_3,_cut_4));
	nChains = 1225;
	}
        if(_batch==3){
	fin.open("/star/u/yhleung2/pwg/33.standard_reco/taxi_ht_pico_tree_newdata_rotate_2_chihe_codata/filelist.txt");
        strcpy (ofile,Form("run18_3gev_ht_hist_pico_rotate_2_centa%d_cut%d_%d%d%d%d%d_v20.root",choose_cent,_cut_mode,_cut_0,_cut_1,_cut_2,_cut_3,_cut_4));
	nChains = 1225;
	}
        if(_batch==4){
	fin.open("/star/u/yhleung2/pwg/33.standard_reco/taxi_ht_pico_tree_newdata_rotate_3_chihe_codata/filelist.txt");
        strcpy (ofile,Form("run18_3gev_ht_hist_pico_rotate_3_centa%d_cut%d_%d%d%d%d%d_v20.root",choose_cent,_cut_mode,_cut_0,_cut_1,_cut_2,_cut_3,_cut_4));
	nChains = 1225;
	}
        if(_batch==5){
	fin.open("/star/u/yhleung2/pwg/33.standard_reco/taxi_ht_pico_tree_newdata_rotate_4_chihe_codata/filelist.txt");        
        strcpy (ofile,Form("run18_3gev_ht_hist_pico_rotate_4_centa%d_cut%d_%d%d%d%d%d_v20.root",choose_cent,_cut_mode,_cut_0,_cut_1,_cut_2,_cut_3,_cut_4));
	nChains = 1225;
	}
        if(_batch==6){
	fin.open("/star/u/yhleung2/pwg/33.standard_reco/taxi_ht_pico_tree_newdata_rotate_5_chihe_codata/filelist.txt");
        strcpy (ofile,Form("run18_3gev_ht_hist_pico_rotate_5_centa%d_cut%d_%d%d%d%d%d_v20.root",choose_cent,_cut_mode,_cut_0,_cut_1,_cut_2,_cut_3,_cut_4));
	nChains = 1224;
	}
        if(_batch==7){
        fin.open("/star/u/yhleung2/pwg/33.standard_reco/taxi_ht_pico_tree_newdata_rotate_6_chihe_codata/filelist.txt");
        strcpy (ofile,Form("run18_3gev_ht_hist_pico_rotate_6_centa%d_cut%d_%d%d%d%d%d_v20.root",choose_cent,_cut_mode,_cut_0,_cut_1,_cut_2,_cut_3,_cut_4));
	nChains = 1224;
	}
	}
