...
*/
bool _isPico;
//void analysismudst_3b(TString picolist="filelist_3b_test.list",  TString outFileName="test27gev1.root", bool _isPico=false)
void analysismudst_3b_test(TString picolist="3b2_list_test.list",  TString outFileName="test27gev1.root", bool _isPico=false)
{
