...
void book_histo();
void write_histo();
void process_tree_tmva_ks_kf_vn_v2(int condor=0,int evt_plane=0){
...
//strcpy (ofile,Form("run18_27gev_ks_kf_flow_weighted_evt%d.root",_evt_plane));

fin.open("/star/u/yhleung2/pwg/33.standard_reco/taxi_ks_ana_flow_rotate_v2/filelist.txt");
strcpy (ofile,Form("run18_27gev_ks_kf_rotate_flow_weighted_evt%d.root",_evt_plane));
