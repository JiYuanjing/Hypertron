...
void book_histo();
void write_histo();
void process_tree_hyl_kf(int condor=0){
...
//TChain htriton_tree("omega_tree");
...
//htriton_tree.SetBranchAddress("ld_chi2topo", &ld_chi2topo);
//htriton_tree.SetBranchAddress("ld_chi2ndf", &ld_chi2ndf);
//htriton_tree.SetBranchAddress("ld_ldl", &ld_ldl);
//htriton_tree.SetBranchAddress("ld_l", &ld_l);
...
//htriton_tree.SetBranchAddress("fCentrality", &fCentrality);
//htriton_tree.SetBranchAddress("psi_1_EPD_0", &psi_1_EPD_0);
//htriton_tree.SetBranchAddress("psi_1_EPD_1", &psi_1_EPD_1);
//htriton_tree.SetBranchAddress("psi_1_EPD_2", &psi_1_EPD_2);
//htriton_tree.SetBranchAddress("psi_1_EPD_3", &psi_1_EPD_3);
...
if(bparticleid>0 && bparticlemass>htriton_mass-0.005 && bparticlemass<htriton_mass+0.005 ){
