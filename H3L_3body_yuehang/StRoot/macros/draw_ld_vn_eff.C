...
TH2F *g_pt_fine2_wgt;
int _cut_mode;
void draw_ld_vn_eff(int cut_mode){
...
f0 = new TFile(Form("run18_3gev_ld_hist_mu_1x_7_newreweight_centa0_cut%d_v15.root",_cut_mode),"READ");
...
TFile *outhistfile = new TFile (Form("ld_vn_eff_v0_cut%d_v15.root",_cut_mode), "RECREATE");
outhistfile->cd();
