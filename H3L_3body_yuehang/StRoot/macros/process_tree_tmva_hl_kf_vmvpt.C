...
void process_tree_tmva_hl_kf_vmvpt(int condor=0, int cut_mode=1, int wgt=4, int batch=0, int cut_0=0, int cut_1=0, int cut_2=0, int cut_3=0, int cut_4=0){
...
//strcpy (ofile, Form("run18_3gev_hl_hist_mu_1x_8_newreweight_centa%d_wgt%d_cut%d_%d%d%d%d%d_mve_vmvpt.root",choose_cent,_wgt,_cut_mode,_cut_0,_cut_1,_cut_2,_cut_3,_cut_4));
//nChains = 1268;

//fin.open("/star/u/yhleung2/pwg/33.standard_reco/taxi_hl_mu_manualvtxerr_newpid/filelist.txt");
//strcpy (ofile, Form("run18_3gev_hl_hist_mu_1x_8_newreweight_centa%d_wgt%d_cut%d_%d%d%d%d%d_mve_newpid_vmvpt.root",choose_cent,_wgt,_cut_mode,_cut_0,_cut_1,_cut_2,_cut_3,_cut_4));
//nChains = 1262;

fin.open("/star/u/yhleung2/pwg/33.standard_reco/taxi_hl_mu_manualvtxerr_nohepid/filelist.txt");
strcpy (ofile, Form("run18_3gev_hl_hist_mu_1x_8_newreweight_centa%d_wgt%d_cut%d_%d%d%d%d%d_mve_nopid_vmvpt.root",choose_cent,_wgt,_cut_mode,_cut_0,_cut_1,_cut_2,_cut_3,_cut_4));
nChains = 1261;
...
h_pl_pt_pi = new TH2F("h_pl_pt_pi","",500,0,100,500,0,5);
  ...
  g_pt = new TH2F("g_pt","",100,-1.0,1.0,50,0,5);
