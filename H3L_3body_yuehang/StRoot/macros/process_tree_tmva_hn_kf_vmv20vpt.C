...
void process_tree_tmva_hn_kf_vmv20vpt(int condor=0, int cut_mode=2, int wgt=4, int batch=0, int cut_0=0, int cut_1=0, int cut_2=0, int cut_3=0, int cut_4=2, int _choose_cent = 1){
...
//fin.open("/star/u/yhleung2/pwg/33.standard_reco/taxi_hn_mu_manualvtxerr_nohepid_chihe_off_final_codata/filelist.txt");
//strcpy (ofile, Form("run18_3gev_hn_hist_mu_1x_14_newreweight_centa%d_wgt%d_cut%d_%d%d%d%d%d_nohepid_v20vpt.root",choose_cent,_wgt,_cut_mode,_cut_0,_cut_1,_cut_2,_cut_3,_cut_4));
//nChains = 539;
...
//new pid
	if(_batch==0){
fin.open("/star/u/yhleung2/pwg/33.standard_reco/taxi_hn_pico_tree_newdata_chihe_codata/filelist.txt");
strcpy (ofile,Form("run18_3gev_hn_hist_pico_centa%d_cut%d_%d%d%d%d%d_v20vpt.root",choose_cent,_cut_mode,_cut_0,_cut_1,_cut_2,_cut_3,_cut_4));
nChains = 1178;
   	}
if(_batch==1){
fin.open("/star/u/yhleung2/pwg/33.standard_reco/taxi_hn_pico_tree_newdata_rotate_0_chihe_codata/filelist.txt");
strcpy (ofile,Form("run18_3gev_hn_hist_pico_rotate_0_centa%d_cut%d_%d%d%d%d%d_v20vpt.root",choose_cent,_cut_mode,_cut_0,_cut_1,_cut_2,_cut_3,_cut_4));
nChains = 1210;
}
        if(_batch==2){
fin.open("/star/u/yhleung2/pwg/33.standard_reco/taxi_hn_pico_tree_newdata_rotate_1_chihe_codata/filelist.txt");
strcpy (ofile,Form("run18_3gev_hn_hist_pico_rotate_1_centa%d_cut%d_%d%d%d%d%d_v20vpt.root",choose_cent,_cut_mode,_cut_0,_cut_1,_cut_2,_cut_3,_cut_4));
nChains = 1222;
}
        if(_batch==3){
fin.open("/star/u/yhleung2/pwg/33.standard_reco/taxi_hn_pico_tree_newdata_rotate_2_chihe_codata/filelist.txt");
strcpy (ofile,Form("run18_3gev_hn_hist_pico_rotate_2_centa%d_cut%d_%d%d%d%d%d_v20vpt.root",choose_cent,_cut_mode,_cut_0,_cut_1,_cut_2,_cut_3,_cut_4));
nChains = 1223;
}
        if(_batch==4){
fin.open("/star/u/yhleung2/pwg/33.standard_reco/taxi_hn_pico_tree_newdata_rotate_3_chihe_codata/filelist.txt");
strcpy (ofile,Form("run18_3gev_hn_hist_pico_rotate_3_centa%d_cut%d_%d%d%d%d%d_v20vpt.root",choose_cent,_cut_mode,_cut_0,_cut_1,_cut_2,_cut_3,_cut_4));
nChains = 1224;
}
        if(_batch==5){
fin.open("/star/u/yhleung2/pwg/33.standard_reco/taxi_hn_pico_tree_newdata_rotate_4_chihe_codata/filelist.txt");
strcpy (ofile,Form("run18_3gev_hn_hist_pico_rotate_4_centa%d_cut%d_%d%d%d%d%d_v20vpt.root",choose_cent,_cut_mode,_cut_0,_cut_1,_cut_2,_cut_3,_cut_4));
nChains = 1223;
}
if(_batch==6){
fin.open("/star/u/yhleung2/pwg/33.standard_reco/taxi_hn_pico_tree_newdata_rotate_5_chihe_codata/filelist.txt");
strcpy (ofile,Form("run18_3gev_hn_hist_pico_rotate_5_centa%d_cut%d_%d%d%d%d%d_v20vpt.root",choose_cent,_cut_mode,_cut_0,_cut_1,_cut_2,_cut_3,_cut_4));
nChains = 1224;
}
if(_batch==7){
fin.open("/star/u/yhleung2/pwg/33.standard_reco/taxi_hn_pico_tree_newdata_rotate_6_chihe_codata/filelist.txt");
strcpy (ofile,Form("run18_3gev_hn_hist_pico_rotate_6_centa%d_cut%d_%d%d%d%d%d_v20vpt.root",choose_cent,_cut_mode,_cut_0,_cut_1,_cut_2,_cut_3,_cut_4));
nChains = 1225;
}
...
//	//force the eta cut
	...
	if(bparticleid==3103 && ((bismc==1&&_condor==0) || _condor==1 || _condor==2) ){
	...
	if(bparticleid==3103 && (bismc==1&&_condor==0) ){
	if(bparticlemass>mass_lo && bparticlemass<mass_hi){
...
if(bmcparticleid!=3103) continue;
