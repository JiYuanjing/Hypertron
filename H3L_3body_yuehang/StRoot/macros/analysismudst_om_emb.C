...
*/
bool _isPico;
//void analysismudst(TString picolist="test27gev.list",  TString outFileName="test27gev.root", bool _isPico=true)
void analysismudst_om_emb(TString picolist="test_omega.list",  TString outFileName="test27gev.root", bool _isPico=false)
{
 TStopwatch timer;
 timer.Start();
