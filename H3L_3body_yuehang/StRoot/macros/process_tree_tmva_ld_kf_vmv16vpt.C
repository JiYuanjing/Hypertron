...
void process_tree_tmva_ld_kf_vmv16vpt(int condor=0, int cut_mode=0){
...
strcpy (ofile, Form("run18_3gev_ld_hist_nopid_newrapptreweight_fidcut_centa%d_v16.root",choose_cent));//rap dep pt weight levy4-8
nChains = 968;
...
//strcpy (ofile,Form("run18_3gev_ld_hist_pico_loose_v16_fidcut_centa%d.root",choose_cent));
//nChains = 1225;

fin.open("/star/u/yhleung2/pwg/33.standard_reco/taxi_ld_pico_rotate_tree_newdata2/filelist.txt");
strcpy (ofile,Form("run18_3gev_ld_hist_pico_rotate_loose_v16_fidcut_centa%d.root",choose_cent));
nChains = 1222;
