...
void process_tree_27_ht_kf_vmv9(int condor=0, int cut_mode=0, int wgt=2, int batch=0){
...
strcpy (ofile,Form("run18_27gev_ht_hist_pico_loose_8_centa%d_cut%d_v9.root",choose_cent,_cut_mode));
nChains = 8217;
   	}
	if(_batch==1){
   	fin.open("/star/u/yhleung2/pwg/33.standard_reco/taxi_ht_27_pico_tree_newpid_rotate_0/filelist.txt");
   	strcpy (ofile,Form("run18_27gev_ht_hist_pico_rotate_0_loose_8_centa%d_cut%d_v9.root",choose_cent,_cut_mode));
nChains = 8223;
	}
	if(_batch==2){
	fin.open("/star/u/yhleung2/pwg/33.standard_reco/taxi_ht_pico_tree_newpid2_rotate_1/filelist.txt");
        strcpy (ofile,Form("run18_3gev_ht_hist_pico_rotate_1_bdt_10_centa%d_cut%d_v9.root",choose_cent,_cut_mode));
nChains = 1219;
	}
        if(_batch==3){
	fin.open("/star/u/yhleung2/pwg/33.standard_reco/taxi_ht_pico_tree_newpid2_rotate_2/filelist.txt");
        strcpy (ofile,Form("run18_3gev_ht_hist_pico_rotate_2_bdt_10_centa%d_cut%d_v9.root",choose_cent,_cut_mode));
nChains = 1214;
	}
        if(_batch==4){
	fin.open("/star/u/yhleung2/pwg/33.standard_reco/taxi_ht_pico_tree_newpid2_rotate_3/filelist.txt");
        strcpy (ofile,Form("run18_3gev_ht_hist_pico_rotate_3_bdt_10_centa%d_cut%d.root_v9",choose_cent,_cut_mode));
nChains = 1220;
	}
	...
	fin.open("/star/u/yhleung2/pwg/33.standard_reco/taxi_ht_pico_tree_newpid2_rotate_4/filelist.txt");        
        strcpy (ofile,Form("run18_3gev_ht_hist_pico_rotate_4_bdt_10_centa%d_cut%d.root_v9",choose_cent,_cut_mode));
nChains = 1221;
	}
        if(_batch==6){
	fin.open("/star/u/yhleung2/pwg/33.standard_reco/taxi_ht_pico_tree_newpid2_rotate_5/filelist.txt");
        strcpy (ofile,Form("run18_3gev_ht_hist_pico_rotate_5_bdt_10_centa%d_cut%d.root_v9",choose_cent,_cut_mode));
nChains = 1221;
	}
        if(_batch==7){
        fin.open("/star/u/yhleung2/pwg/33.standard_reco/taxi_ht_pico_tree_newpid2_rotate_6/filelist.txt");
        strcpy (ofile,Form("run18_3gev_ht_hist_pico_rotate_6_bdt_10_centa%d_cut%d.root_v9",choose_cent,_cut_mode));
nChains = 1221;
	}
//	nChains = 1200;
	}
...
// bmcrap = mcptc.Rapidity() - ycm; 
	...
	if(ht_pl<2) continue;//no signal for ht_pl<6
	//TODO
...
h_dedx_p = new TH2F("h_dedx_p","",500,0,5,2000,0,100);
  ...
  h_mass_pt_wgt = new TH3F("h_mass_pt_wgt","",1000,min_mass,max_mass,40,-1.0,1.0,50,0,5);
  h_mass_pl_wgt = new TH3F("h_mass_pl_wgt","",1000,min_mass,max_mass,40,-1.0,1.0,500,0,100);
