...
void process_tree_26p5_hl_kf_vmv9(int condor=0, int cut_mode=0, int wgt=2, int batch=0){
  ...
  t_quadr->SetParameters(4.71255e-01,0.00000e+00,1.79971e+00*1.5);//this is from fit to 7gevv data, multiply second paramter by 1.5
  //t_quadr0->SetParameters(4.71255e-01,0.00000e+00,1.79971e+00);//this is from fit to 7gevv data,h3l
  t_quadr0->SetParameters(7.03832e-01,0.,9.60834e-01);//this is from fit to 7gevv data,h4l
  t_quadr1->SetParameters(6.88265e+01, 0.0, 1.90472e+02);
  ...
  */
  ...
  if(_condor==0){//emb
    ...
    //strcpy (ofile,"run18_7gev_ht_hist_mu.root");
    //fin.open("/star/u/yhleung2/pwg/33.standard_reco/filelist_ht_emb3.txt");
    //strcpy (ofile,"run18_7gev_ht_hist_mu3.root");
    //fin.open("/star/u/yhleung2/pwg/33.standard_reco/taxi_ht_mu3_correctedvertex/sum/filelist.txt");
    //strcpy (ofile,"run18_7gev_ht_hist_mu4.root");

    //fin.open("/star/u/yhleung2/pwg/33.standard_reco/taxi_ht_mu3_correctedvertex_anderror/filelist.txt");
    //strcpy (ofile,"run18_7gev_ht_hist_mu5.root");
    //fin.open("/star/u/yhleung2/pwg/33.standard_reco/taxi_ht_mu3_correctedvertex_andnoerror/filelist.txt");
    //strcpy (ofile,"run18_7gev_ht_hist_mu5noerr.root");

    //fin.open("/star/u/yhleung2/pwg/33.standard_reco/taxi_ht_mu3_correctedvertex_werror2/filelist.txt");
    //strcpy (ofile, "run18_7gev_ht_hist_mu6.root");
    //nChains = 1;
    //fin.open("/star/u/yhleung2/pwg/33.standard_reco/taxi_ht_mu3_correctedvertex_werror4/filelist.txt");
    //strcpy (ofile, "run18_7gev_ht_hist_mu7.root");

    //fin.open("/star/u/yhleung2/pwg/33.standard_reco/taxi_ht_mu3_correctedvertex_werror_veryloose/filelist.txt");
    //strcpy (ofile, "run18_7gev_ht_hist_mu_veryloose.root");
    //nChains = 1;

    //fin.open("/star/u/yhleung2/pwg/33.standard_reco/taxi_ht_mu3_correctedvertex_werror_3/sum/filelist.txt");
    //strcpy (ofile, "run18_7gev_ht_hist_mu_3.root");
    //nChains = 1;

    //fin.open("/star/u/yhleung2/pwg/33.standard_reco/taxi_ht_mu3_correctedvertex_w10xerror_3/sum/filelist.txt");
    //strcpy (ofile, "run18_7gev_ht_hist_mu_10x_3.root");
    //nChains = 1;

    //fin.open("/star/u/yhleung2/pwg/33.standard_reco/taxi_ht_mu3_correctedvertex_w5xerror_4/filelist.txt");
    //strcpy (ofile, Form("run18_7gev_ht_hist_mu_5x_3_newreweight_centa%d.root",choose_cent));
    //nChains = 1;

    //fin.open("/star/u/yhleung2/pwg/33.standard_reco/taxi_ht_mu3_correctedvertex_w5xerror_5/filelist.txt");
    //strcpy (ofile, Form("run18_7gev_ht_hist_mu_5x_5_newreweight_centa%d.root",choose_cent));
    //nChains = 326;

    //fin.open("/star/u/yhleung2/pwg/33.standard_reco/taxi_ht_mu/filelist.txt");
    //strcpy (ofile, Form("run18_7gev_ht_hist_mu_1x_1_newreweight_centa%d.root",choose_cent));
    //nChains = 90;

    //fin.open("/star/u/yhleung2/pwg/33.standard_reco/taxi_hl_mu_4/filelist.txt");
    //strcpy (ofile, Form("run18_7gev_hl_hist_mu_1x_4_newreweight_centa%d_wgt%d_cut%d.root",choose_cent,_wgt,_cut_mode));
    //nChains = 262;

    fin.open("/star/u/yhleung2/pwg/33.standard_reco/taxi_hl_mu_newpid2_manualvtxerr/filelist.txt");
    strcpy (ofile, Form("run18_7gev_hl_hist_mu_1x_8_newreweight_centa%d_wgt%d_cut%d_mve_v9.root",choose_cent,_wgt,_cut_mode));
    nChains = 1268;

  }
  if(_condor==1){//data
    //fin.open("/star/u/yhleung2/pwg/33.standard_reco/taxi_ht_pico/sum/filelist.txt");
    //strcpy (ofile,"run18_7gev_ht_hist_pico.root");
    //
    //fin.open("/star/u/yhleung2/pwg/33.standard_reco/taxi_ht_pico_rotate/sum/filelist.txt");
    //strcpy (ofile,"run18_7gev_ht_hist_pico_rotate.root");
    //nChains = 1;
    //
    //loose cuts
    //fin.open("/star/u/yhleung2/pwg/33.standard_reco/taxi_ht_pico_tree/filelist.txt");
    //strcpy (ofile,"run18_7gev_ht_hist_pico_loose.root");
    //fin.open("/star/u/yhleung2/pwg/33.standard_reco/taxi_ht_pico_rotate_tree/filelist.txt");
    //strcpy (ofile,"run18_7gev_ht_hist_pico_rotate_loose.root");
    //nChains = 1200;

    //fin.open("/star/u/yhleung2/pwg/33.standard_reco/taxi_ht_pico_tree_2/filelist.txt");
    //strcpy (ofile,"run18_7gev_ht_hist_pico_loose_7.root");
    //fin.open("/star/u/yhleung2/pwg/33.standard_reco/taxi_ht_pico_rotate_tree_2/filelist.txt");
    //strcpy (ofile,"run18_7gev_ht_hist_pico_rotate_loose_7.root");

    //fin.open("/star/u/yhleung2/pwg/33.standard_reco/taxi_ht_pico_tree_4/filelist.txt");
    //strcpy (ofile,Form("run18_7gev_ht_hist_pico_loose_4_centa%d.root",choose_cent));
    //fin.open("/star/u/yhleung2/pwg/33.standard_reco/taxi_ht_pico_rotate_tree_4/filelist.txt");
    //strcpy (ofile,Form("run18_7gev_ht_hist_pico_rotate_loose_4_centa%d.root",choose_cent));
    //nChains = 1200;


    if(_batch==0){
      //fin.open("/star/u/yhleung2/pwg/33.standard_reco/taxi_ht_pico_tree_newpid_0//filelist.txt");
      //strcpy (ofile,Form("run18_7gev_hl_hist_pico_loose_7_centa%d_cut%d.root",choose_cent,_cut_mode));

      fin.open("/star/u/yhleung2/pwg/33.standard_reco/taxi_ht_26p5_pico_tree_newpid/filelist.txt");
      strcpy (ofile,Form("run18_7gev_hl_hist_pico_loose_8_centa%d_cut%d_v10.root",choose_cent,_cut_mode));
      nChains = 762;
    }
    if(_batch==1){
      fin.open("/star/u/yhleung2/pwg/33.standard_reco/taxi_ht_26p5_pico_tree_newpid_rotate_0/filelist.txt");
      strcpy (ofile,Form("run18_7gev_hl_hist_pico_rotate_1_loose_8_centa%d_cut%d_v10.root",choose_cent,_cut_mode));
      nChains = 767;
    }
    if(_batch==2){
      fin.open("/star/u/yhleung2/pwg/33.standard_reco/taxi_ht_26p5_pico_tree_newpid_rotate_1/filelist.txt");
      strcpy (ofile,Form("run18_7gev_hl_hist_pico_rotate_2_loose_8_centa%d_cut%d_v10.root",choose_cent,_cut_mode));
      nChains = 767;
    }
    if(_batch==3){
      fin.open("/star/u/yhleung2/pwg/33.standard_reco/taxi_ht_26p5_pico_tree_newpid_rotate_2/filelist.txt");
      strcpy (ofile,Form("run18_7gev_hl_hist_pico_rotate_3_loose_8_centa%d_cut%d_v10.root",choose_cent,_cut_mode));
      nChains = 767;
    }
    if(_batch==4){
      fin.open("/star/u/yhleung2/pwg/33.standard_reco/taxi_ht_26p5_pico_tree_newpid_rotate_3/filelist.txt");
      strcpy (ofile,Form("run18_7gev_hl_hist_pico_rotate_4_loose_8_centa%d_cut%d_v10.root",choose_cent,_cut_mode));
      nChains = 767;
    }
    if(_batch==5){
      fin.open("/star/u/yhleung2/pwg/33.standard_reco/taxi_ht_26p5_pico_tree_newpid_rotate_4/filelist.txt");
      strcpy (ofile,Form("run18_7gev_hl_hist_pico_rotate_5_loose_8_centa%d_cut%d_v10.root",choose_cent,_cut_mode));
      nChains = 765;
    }
    if(_batch==6){
      fin.open("/star/u/yhleung2/pwg/33.standard_reco/taxi_ht_26p5_pico_tree_newpid_rotate_5/filelist.txt");
      strcpy (ofile,Form("run18_7gev_hl_hist_pico_rotate_6_loose_8_centa%d_cut%d_v10.root",choose_cent,_cut_mode));
      nChains = 765;
    }
    if(_batch==7){
      fin.open("/star/u/yhleung2/pwg/33.standard_reco/taxi_ht_26p5_pico_tree_newpid_rotate_6/filelist.txt");
      strcpy (ofile,Form("run18_7gev_hl_hist_pico_rotate_7_loose_8_centa%d_cut%d_v10.root",choose_cent,_cut_mode));
      nChains = 765;
    }
  ...
  for (Long64_t iEntry = 0; iEntry<=n_lambda_Entries; iEntry++){
    ...
    if(bparticleid==3005 && ((bismc==1&&_condor==0) || _condor==1 || _condor==2) ){
      ...
      if( bpt>3.0) continue;
      if( brap+xshift>0.95) continue;
      if( brap+xshift>0.7  &&  bpt < 4.9*(brap+xshift-0.50)*(brap+xshift-0.50)+0.40+0.017 ) continue;
      if( brap+xshift<0.7  &&  bpt < 2.25*(brap+xshift-0.80)*(brap+xshift-0.80)+0.5-0.029+0.1195 ) continue;
...
void book_histo()
{
  ...
  h_mass_pt = new TH3F("h_mass_pt","",1000,min_mass,max_mass,40,-1.0,3.0,50,0,5);
  h_mass_pl = new TH3F("h_mass_pl","",1000,min_mass,max_mass,40,-1.0,3.0,500,0,100);

  h_mass_pt_wgt = new TH3F("h_mass_pt_wgt","",1000,min_mass,max_mass,40,-1.0,3.0,50,0,5);
  h_mass_pl_wgt = new TH3F("h_mass_pl_wgt","",1000,min_mass,max_mass,40,-1.0,3.0,500,0,100);

  h_mass_qa = new TH3F("h_mass_qa","",10,-3.0,-0.0,50,0,5,1000,min_mass,max_mass);
  h_chi2primary_he = new TH3F("h_chi2primary_he","",10,-3.0,0.0,50,0,5,500,0,500);
  h_chi2primary_pi = new TH3F("h_chi2primary_pi","",10,-3.0,0.0,50,0,5,500,0,500);
  h_ht_ldl = new TH3F("h_ht_ldl","",10,-3.0,0.0,50,0,5,1000,0,200);
  h_ht_l = new TH3F("h_ht_l","",10,-3.0,0.0,50,0,5,1000,0,200);
  h_ht_dl = new TH3F("h_ht_dl","",10,-3.0,0.0,50,0,5,500,0,20);
  h_ht_chi2topo = new TH3F("h_ht_chi2topo","",10,-3.0,0.0,50,0,5,500,0,10);
  h_ht_chi2ndf = new TH3F("h_ht_chi2ndf","",10,-3.0,0.0,50,0,5,100,0,10);
  h_nhits_he = new TH3F("h_nhits_he","",10,-3.0,0.0,50,0,5,80,0,80);
  h_nhits_pi = new TH3F("h_nhits_pi","",10,-3.0,0.0,50,0,5,80,0,80);

  h_ht_dca_he = new TH3F("h_ht_dca_he","",10,-3.0,0.0,50,0,5,200,0,20);
  h_ht_dca_pi     = new TH3F("h_ht_dca_pi","",10,-3.0,0.0,50,0,5,200,0,20);

  h_ht_bdfvtx = new TH3F("h_ht_bdfvtx","",10,-3.0,0.0,50,0,5,1000,0,5);
  h_ht_bdfvtx2 = new TH3F("h_ht_bdfvtx2","",10,-3.0,0.0,50,0,5,1000,0,1);
  h_ht_lifetime = new TH3F("h_ht_lifetime","",10,-3.0,0.0,50,0,5,500,0,100);

  h_ht_bdt = new TH3F("h_ht_bdt","",10,-3.0,0.0,50,0,5,200,-1.,1.);
  h_cent = new TH1F("h_cent","", 9,0,9);

  h_bnhits = new TH3F("h_bnhits","",10,-3.0,0.0,50,0,5,70,0,70);
  h_bdedx = new TH3F("h_bdedx","",10,-3.0,0.0,50,0,5,100,0,100);
  h_pt = new TH2F("h_pt","",100,-0.5,2.5,100,0,10);
  h_r_pt = new TH2F("h_r_pt","",100,-2.5,0.5,100,0,10);
  h_eta = new TH2F("h_eta","",200,-2.5,0.5,100,0,10);
  h_rap = new TH2F("h_rap","",200,-3.0,-0.0,100,0,10);
  h_dca = new TH3F("h_dca","",10,-3.0,0.0,50,0,5,500,0,20);
  g_pt = new TH2F("g_pt","",10,-3.0,0.0,50,0,5);
  g_pl = new TH2F("g_pl","",10,-3.0,0.0,500,0,100);
  g_pt_fine = new TH2F("g_pt_fine","",100,-3.0,0.0,50,0,5);
  g_pt_fine2 = new TH2F("g_pt_fine2","",20,-3.0,0.0,50,0,5);
  g_pt_fine_wgt = new TH2F("g_pt_fine_wgt","",100,-3.0,0.0,50,0,5);
  g_pt_fine2_wgt = new TH2F("g_pt_fine2_wgt","",20,-3.0,0.0,50,0,5);

  g_pt_wgt = new TH2F("g_pt_wgt","",100,-3.0,0.0,50,0,5);
  g_pl_wgt = new TH2F("g_pl_wgt","",10,-3.0,0.0,500,0,100);
