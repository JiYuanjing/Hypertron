...
void process_tree_tmva_ld_kf_vmv7(int condor=0, int cut_mode=0){
...
fgpt_0 = new TFile("h_gpt_ld.root","READ");
...
strcpy (ofile, Form("run18_3gev_ld_hist_mu_1x_4_newreweight_centa%d.root",choose_cent));
nChains = 196;
}
if(_condor==1){//data
