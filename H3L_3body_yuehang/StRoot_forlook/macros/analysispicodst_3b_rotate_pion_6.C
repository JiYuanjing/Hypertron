...
*/
bool _isPico;
void analysispicodst_3b_rotate_pion_6(TString picolist="test.list",  TString outFileName="test27gev1.root", bool _isPico=true)
{
...
StKFParticleInterface::instance()->SetRotation();
  StKFParticleInterface::instance()->SetRotationAngle(TMath::Pi()*1.75);
