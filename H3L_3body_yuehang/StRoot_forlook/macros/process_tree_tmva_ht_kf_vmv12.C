...
void process_tree_tmva_ht_kf_vmv12(int condor=0, int cut_mode=0, int wgt=2, int batch=0, int cut_0=0, int cut_1=0, int cut_2=0, int cut_3=0 , int cut_4=0){
...
strcpy (ofile, Form("run18_3gev_ht_hist_mu_1x_14_newreweight_centa%d_wgt%d_cut%d_%d%d%d%d%d_v11.root",choose_cent,_wgt,_cut_mode,_cut_0,_cut_1,_cut_2,_cut_3,_cut_4));
nChains = 1126;
}
if(_condor==1){//data
...
//new pid
	if(_batch==0){
   	...
   	strcpy (ofile,Form("run18_3gev_ht_hist_pico_bdt_10_centa%d_cut%d_%d%d%d%d%d_v11.root",choose_cent,_cut_mode,_cut_0,_cut_1,_cut_2,_cut_3,_cut_4));
nChains = 1222;
   	}
	if(_batch==1){
   	fin.open("/star/u/yhleung2/pwg/33.standard_reco/taxi_ht_pico_tree_newpid2_rotate_0/filelist.txt");
   	strcpy (ofile,Form("run18_3gev_ht_hist_pico_rotate_0_bdt_10_centa%d_cut%d_%d%d%d%d%d_v11.root",choose_cent,_cut_mode,_cut_0,_cut_1,_cut_2,_cut_3,_cut_4));
nChains = 1208;
	}
	if(_batch==2){
	fin.open("/star/u/yhleung2/pwg/33.standard_reco/taxi_ht_pico_tree_newpid2_rotate_1/filelist.txt");
        strcpy (ofile,Form("run18_3gev_ht_hist_pico_rotate_1_bdt_10_centa%d_cut%d_%d%d%d%d%d_v11.root",choose_cent,_cut_mode,_cut_0,_cut_1,_cut_2,_cut_3,_cut_4));
nChains = 1219;
	}
        if(_batch==3){
	fin.open("/star/u/yhleung2/pwg/33.standard_reco/taxi_ht_pico_tree_newpid2_rotate_2/filelist.txt");
        strcpy (ofile,Form("run18_3gev_ht_hist_pico_rotate_2_bdt_10_centa%d_cut%d_%d%d%d%d%d_v11.root",choose_cent,_cut_mode,_cut_0,_cut_1,_cut_2,_cut_3,_cut_4));
nChains = 1214;
	}
        if(_batch==4){
	fin.open("/star/u/yhleung2/pwg/33.standard_reco/taxi_ht_pico_tree_newpid2_rotate_3/filelist.txt");
        strcpy (ofile,Form("run18_3gev_ht_hist_pico_rotate_3_bdt_10_centa%d_cut%d_%d%d%d%d%d_v11.root",choose_cent,_cut_mode,_cut_0,_cut_1,_cut_2,_cut_3,_cut_4));
nChains = 1220;
	}
	...
	fin.open("/star/u/yhleung2/pwg/33.standard_reco/taxi_ht_pico_tree_newpid2_rotate_4/filelist.txt");        
        strcpy (ofile,Form("run18_3gev_ht_hist_pico_rotate_4_bdt_10_centa%d_cut%d_%d%d%d%d%d_v11.root",choose_cent,_cut_mode,_cut_0,_cut_1,_cut_2,_cut_3,_cut_4));
nChains = 1221;
	}
        if(_batch==6){
	fin.open("/star/u/yhleung2/pwg/33.standard_reco/taxi_ht_pico_tree_newpid2_rotate_5/filelist.txt");
        strcpy (ofile,Form("run18_3gev_ht_hist_pico_rotate_5_bdt_10_centa%d_cut%d_%d%d%d%d%d_v11.root",choose_cent,_cut_mode,_cut_0,_cut_1,_cut_2,_cut_3,_cut_4));
nChains = 1221;
	}
        if(_batch==7){
        fin.open("/star/u/yhleung2/pwg/33.standard_reco/taxi_ht_pico_tree_newpid2_rotate_6/filelist.txt");
        strcpy (ofile,Form("run18_3gev_ht_hist_pico_rotate_6_bdt_10_centa%d_cut%d_%d%d%d%d%d_v11.root",choose_cent,_cut_mode,_cut_0,_cut_1,_cut_2,_cut_3,_cut_4));
nChains = 1221;
	}
	}
...
px_pi_cut = 0;
        ...
        if(_cut_4 ==1 ) px_pi_cut = 0.15;
        if(_cut_4 ==2 ) px_pi_cut = 0.20;
