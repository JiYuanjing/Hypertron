...
void process_tree_26p5_ht_kf_vmv9(int condor=0, int cut_mode=0, int wgt=2, int batch=0){
...
//	t_quadr->SetParameters(2.06539, 0.0, -1.75299);//this is from fit to 3gevlambdadata
	...
	for(int ipt=0;ipt<nptbins;ipt++){
 	...
 	reader[ipt] =  new TMVA::Reader( "!Color:!Silent" );
        ...
        reader[ipt]->AddVariable("chi2primary_he", &chi2primary_he);//TODO!!!
...
strcpy (ofile, Form("run18_3gev_ht_hist_mu_1x_14_newreweight_centa%d_wgt%d_cut%d_v9.root",choose_cent,_wgt,_cut_mode));
nChains = 1126;
}
if(_condor==1){//data
...
//	strcpy (ofile,Form("run18_7gev_ht_hist_pico_rotate_loose_6_centa%d_cut%d.root",choose_cent,_cut_mode));

//fin.open("/star/u/yhleung2/pwg/33.standard_reco/taxi_ht_pico_rotate_tree_7/filelist.txt");
//strcpy (ofile,Form("run18_7gev_ht_hist_pico_rotate_loose_6_centa%d_cut%d_b1.root",choose_cent,_cut_mode));

//fin.open("/star/u/yhleung2/pwg/33.standard_reco/taxi_ht_pico_rotate_tree_7_clone/filelist.txt");
//strcpy (ofile,Form("run18_7gev_ht_hist_pico_rotate_loose_6_centa%d_cut%d_b2.root",choose_cent,_cut_mode));

//fin.open("/star/u/yhleung2/pwg/33.standard_reco/taxi_ht_pico_rotate_tree_7_clone2/filelist.txt");
//strcpy (ofile,Form("run18_7gev_ht_hist_pico_rotate_loose_6_centa%d_cut%d_b3.root",choose_cent,_cut_mode));

//fin.open("/star/u/yhleung2/pwg/33.standard_reco/taxi_ht_pico_rotate_tree_7_clone3/filelist.txt");
//strcpy (ofile,Form("run18_7gev_ht_hist_pico_rotate_loose_6_centa%d_cut%d_b4.root",choose_cent,_cut_mode));


//new pid
	if(_batch==0){
//   	fin.open("/star/u/yhleung2/pwg/33.standard_reco/taxi_ht_pico_tree_newpid2/filelist.txt");
//   	strcpy (ofile,Form("run18_3gev_ht_hist_pico_bdt_10_centa%d_cut%d_v9.root",choose_cent,_cut_mode));
//nChains = 1222;
fin.open("/star/u/yhleung2/pwg/33.standard_reco/taxi_ht_26p5_pico_tree_newpid/filelist.txt");
strcpy (ofile,Form("run18_7gev_ht_hist_pico_loose_8_centa%d_cut%d_v10.root",choose_cent,_cut_mode));
nChains = 762;
   	}
	if(_batch==1){
   	fin.open("/star/u/yhleung2/pwg/33.standard_reco/taxi_ht_26p5_pico_tree_newpid_rotate_0/filelist.txt");
   	strcpy (ofile,Form("run18_7gev_ht_hist_pico_rotate_0_loose_8_centa%d_cut%d_v10.root",choose_cent,_cut_mode));
nChains = 767;
	}
	if(_batch==2){
	fin.open("/star/u/yhleung2/pwg/33.standard_reco/taxi_ht_26p5_pico_tree_newpid_rotate_1/filelist.txt");
        strcpy (ofile,Form("run18_7gev_ht_hist_pico_rotate_1_loose_8_centa%d_cut%d_v9.root",choose_cent,_cut_mode));
nChains = 767;
	}
        if(_batch==3){
	fin.open("/star/u/yhleung2/pwg/33.standard_reco/taxi_ht_26p5_pico_tree_newpid_rotate_2/filelist.txt");
        strcpy (ofile,Form("run18_7gev_ht_hist_pico_rotate_2_bdt_10_centa%d_cut%d_v9.root",choose_cent,_cut_mode));
nChains = 767;
	}
        if(_batch==4){
	fin.open("/star/u/yhleung2/pwg/33.standard_reco/taxi_ht_26p5_pico_tree_newpid_rotate_3/filelist.txt");
        strcpy (ofile,Form("run18_7gev_ht_hist_pico_rotate_3_bdt_10_centa%d_cut%d.root_v9",choose_cent,_cut_mode));
nChains = 767;
	}
        if(_batch==5){
	fin.open("/star/u/yhleung2/pwg/33.standard_reco/taxi_ht_26p5_pico_tree_newpid_rotate_4/filelist.txt");        
        strcpy (ofile,Form("run18_7gev_ht_hist_pico_rotate_4_bdt_10_centa%d_cut%d.root_v9",choose_cent,_cut_mode));
nChains = 765;
	}
        if(_batch==6){
	fin.open("/star/u/yhleung2/pwg/33.standard_reco/taxi_ht_26p5_pico_tree_newpid_rotate_5/filelist.txt");
        strcpy (ofile,Form("run18_7gev_ht_hist_pico_rotate_5_bdt_10_centa%d_cut%d.root_v9",choose_cent,_cut_mode));
nChains = 765;
	}
        if(_batch==7){
        fin.open("/star/u/yhleung2/pwg/33.standard_reco/taxi_ht_26p5_pico_tree_newpid_rotate_6/filelist.txt");
        strcpy (ofile,Form("run18_7gev_ht_hist_pico_rotate_6_bdt_10_centa%d_cut%d.root_v9",choose_cent,_cut_mode));
nChains = 765;
	}
//	nChains = 1200;
	}
...
// bmcrap = mcptc.Rapidity() - ycm; 
	...
	//testing:
	if(_cut_mode==100){
	if(chi2primary_pi>40) continue;
	        if(ht_chi2topo<3) continue;
	...
	if(bpt>3.0) continue;
        ...
        if( brap+xshift>0.55  &&  bpt < 3.9*(brap+xshift-0.45)*(brap+xshift-0.45)+0.65) continue;
        if( brap+xshift<0.55  &&  bpt < 1.9*(brap+xshift-0.65)*(brap+xshift-0.65)+0.67) continue;
...
//		h_mass_pt->Fill(bparticlemass,brap,bpt);
	...
	rap_weight = 1;
        ...
        weight *= mc_weight;
	weight *= cent_weight;
	//cout<<" weight:"<<weight<<" "<<rap_weight<<" "<<pt_weight<<" "<<mc_weight<<" "<<cent_weight<<" "<<cent_label<<endl; 
        if((_cut_mode<11 || _cut_mode>20/*&& _cut_mode!=12 && _cut_mode!=13*/) || mvaValue>mvaCut){
...
//cout<<"rap_weight:"<<rap_weight<<" "<<pt_weight<<" "<<_wgt<<endl;
     	weight = rap_weight*pt_weight;
     	weight *= mc_weight;
	weight *= cent_weight;
...
h_ht_bdt = new TH3F("h_ht_bdt","",10,-3.0,0.0,50,0,5,200,-1.,1.);
  ...
  h_eta = new TH2F("h_eta","",200,-3.0,0.0,100,0,10);
