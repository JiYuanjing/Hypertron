...
// main GUI
void TMVAGui_ht(const int ptBin = 0)
{
	//int   const nPtBins = 5;
    //float const PtBins[nPtBins+1] = {0., 1., 2., 3., 5., 10.};
  
    const char fName[250] = Form("output/TMVA_rec_ht_pl_wgt_%d.root",ptBin);
    //const char fName[250] = Form("output/TMVA_om_ht_pl_wgt_sideband_%d.root",ptBin);
