...
int _cuts;
void process_mini_he4_v2(int condor=0){
	...
	if(_condor==0){
	fin.open("/star/u/yhleung2/pwg/33.standard_reco/mini_he4_x.list");
	strcpy (ofile, "he4_x.root");
	//strcpy (ofile, "he4_x_etaltm04.root");
	//strcpy (ofile, "he4_x_etagtm04.root");
	nChains = 600;
	}
		
	if(_condor==1){
        fin.open("/star/u/yhleung2/pwg/33.standard_reco/mini_he4.list");
        strcpy (ofile, "he4_1.root");
        //strcpy (ofile, "he4_1_etaltm04.root");
        //strcpy (ofile, "he4_1_etagtm04.root");
        nChains = 1101;
        }
...
*/
	...
	for(int i=0;i<mNMcTrack;i++){
		if(mMcTracksmGeantId[i]!=47) continue;
