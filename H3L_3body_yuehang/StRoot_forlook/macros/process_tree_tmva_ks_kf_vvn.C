//vnn copied from process_tree_tmva_ks_kf_vmv8.C
...
void process_tree_tmva_ks_kf_vvn(int condor=0, int cut_mode=0){
...
levyfit4->SetParameters(0.148924 , -1.21263e+08, 4.7984e+07);
levyfit5->SetParameters(0.144378 , -1.25944e+08, 5.07179e+07);
levyfit6->SetParameters(0.13996 , -1.60907e+08, 4.63159e+07);
levyfit7->SetParameters(0.127585 , -1.60615e+08, 4.05916e+07);
levyfit8->SetParameters(0.113605 , -2.04683e+08, 3.07465e+07);
t_quadr->SetParameters(2.06539, 0.0, -1.75299);

fgpt_0 = new TFile("ks_input_mc_fine.root","READ");
...
//fin.open("/star/u/yhleung2/pwg/33.standard_reco/taxi_ld_mu3_correctedvertex_w5xerror_5/filelist.txt");
//strcpy (ofile, Form("run18_3gev_ld_hist_mu_5x_5_newreweight_centa%d.root",choose_cent));
//nChains = 225;

//fin.open("/star/u/yhleung2/pwg/33.standard_reco/taxi_ld_mu3_correctedvertex_w1xerror_9/filelist.txt");
//strcpy (ofile, Form("run18_3gev_ld_hist_mu_1x_3_newreweight_centa%d.root",choose_cent));
//nChains = 225;



//for vn measurement, default cut
//fin.open("/star/u/yhleung2/pwg/33.standard_reco/taxi_ks_mu3_correctedvertex_w1xerror_vn_eff/filelist.txt");
//strcpy (ofile, Form("run18_3gev_ks_hist_mu_1x_vn_newreweight_centa%d.root",choose_cent));
//nChains = 224;
//
//loose cut
//fin.open("/star/u/yhleung2/pwg/33.standard_reco/taxi_ks_mu3_loose_vn_eff/filelist.txt");
//strcpy (ofile, Form("run18_3gev_ks_hist_mu_1x_vn_newreweight_centa%d_cut%d_v15a.root",choose_cent,_cut_mode));
//nChains = 20;
//nChains = 426;

//official
//fin.open("/star/u/yhleung2/pwg/33.standard_reco/taxi_ks_mu3_loose_vn_eff_off/filelist2.txt");
fin.open("/star/u/yhleung2/pwg/33.standard_reco/taxi_ks_mu3_loose_vn_eff_off/filelist.txt");
strcpy (ofile, Form("run18_3gev_ks_hist_mu_1x_vn_newreweight_centa%d_cut%d_v15b.root",choose_cent,_cut_mode));
nChains = 20;
//nChains = 23;


//for lifetime measurement, loose cut
//fin.open("/star/u/yhleung2/pwg/33.standard_reco/taxi_ld_mu3_correctedvertex_w1xerror_10/filelist.txt");
//strcpy (ofile, Form("run18_3gev_ld_hist_mu_1x_7_newreweight_centa%d.root",choose_cent));
//nChains = 196;
...
ks_mc_tree.Add(path_ch);
cout<<path_ch<<" "<<ks_mc_tree.GetEntries() <<endl;
...
//ks_tree.SetBranchAddress("brunid",&brunid);
ks_tree.SetBranchAddress("brefmult",&brefmult);
ks_tree.SetBranchAddress("btofmult",&btofmult);
...
ks_tree.SetBranchAddress("ld_dl", &ld_dl);
ks_tree.SetBranchAddress("dca_proton",&dca_proton);
ks_tree.SetBranchAddress("dca_pi",&dca_pi);
ks_tree.SetBranchAddress("nhits_ld_pi",&nhits_ld_pi);
ks_tree.SetBranchAddress("nhits_ld_proton",&nhits_ld_proton);
ks_tree.SetBranchAddress("ld_bdfvtx",&ld_bdfvtx);
ks_tree.SetBranchAddress("ld_bdfvtx2",&ld_bdfvtx2);
ks_tree.SetBranchAddress("ld_lifetime",&ld_lifetime);
ks_tree.SetBranchAddress("countrefmult",&countrefmult);
ks_tree.SetBranchAddress("reweight", &reweight);
ks_tree.SetBranchAddress("cent9", &cent9);
ks_tree.SetBranchAddress("bismc", &bismc);

if(_condor==0){
ks_tree.SetBranchAddress("bmcpx",&bmcpx);
ks_tree.SetBranchAddress("bmcpy",&bmcpy);
ks_tree.SetBranchAddress("bmcpz",&bmcpz);
ks_tree.SetBranchAddress("bmcl",&bmcl);
ks_tree.SetBranchAddress("bmcpl",&bmcpl);
ks_tree.SetBranchAddress("bpl",&bpl);
ks_tree.SetBranchAddress("bmcx",&bmcx);
ks_tree.SetBranchAddress("bmcy",&bmcy);
ks_tree.SetBranchAddress("bmcz",&bmcz);
ks_tree.SetBranchAddress("bx",&bx);
ks_tree.SetBranchAddress("by",&by);
ks_tree.SetBranchAddress("bz",&bz);
}
//ks_mc_tree.SetBranchAddress("brunid", &brunid);
ks_mc_tree.SetBranchAddress("brefmult", &brefmult);
ks_mc_tree.SetBranchAddress("bmcparticleid", &bmcparticleid);
ks_mc_tree.SetBranchAddress("bmcrawpx", &bmcrawpx);
ks_mc_tree.SetBranchAddress("bmcrawpy", &bmcrawpy);
ks_mc_tree.SetBranchAddress("bmcrawpz", &bmcrawpz);
ks_mc_tree.SetBranchAddress("bmcrawpl", &bmcrawpl);
ks_mc_tree.SetBranchAddress("reweight", &reweight);
ks_mc_tree.SetBranchAddress("countrefmult", &mccountrefmult);
ks_mc_tree.SetBranchAddress("cent9", &cent9);

Long64_t n_ks_Entries = ks_tree.GetEntries();
Long64_t n_ks_mc_Entries = ks_mc_tree.GetEntries();
...
if(_cut_mode==2 || _cut_mode==11 || _cut_mode==12 || _cut_mode==21 || _cut_mode==22||_cut_mode==31||_cut_mode==32){
ld_chi2topo_cut = 5;
ld_chi2ndf_cut = 5;
ld_ldl_cut = 5;
ld_l_cut = 1;
...
if(chi2primary_proton<chi2primary_proton_cut || chi2primary_pi<chi2primary_pi_cut) continue;
        ...
        if(_cut_mode==11 && nhits_ld_pi<17) continue;
        if(_cut_mode==11 && nhits_ld_proton<17) continue;

        if(_cut_mode==12 && nhits_ld_pi<20) continue;
        if(_cut_mode==12 && nhits_ld_proton<20) continue;
...
h_mass_pt_fine->Fill(bparticlemass,brap,bpt);
h_mass_pt_fine2->Fill(bparticlemass,brap,bpt);
h_r_mass_pt_fine2->Fill(bparticlemass,-brap,bpt);
h_mass_pl->Fill(bparticlemass,brap,ld_pl);
  ...
  if(bismc==1&&_condor==0){
     ...
     float pt_weight;
     pt_weight = levyfit4->Eval(sqrt(bmcpx*bmcpx+bmcpy*bmcpy));

//     weight = rap_weight*pt_weight;
     weight = 1;
/*
if(bmcrap<-0.7){ weight = levyfit8->Eval(sqrt(bmcpx*bmcpx+bmcpy*bmcpy)); }
else if(bmcrap<-0.5){ weight = levyfit7->Eval(sqrt(bmcpx*bmcpx+bmcpy*bmcpy)); }
else if(bmcrap<-0.3){ weight = levyfit6->Eval(sqrt(bmcpx*bmcpx+bmcpy*bmcpy)); }
else if(bmcrap<-0.1){ weight = levyfit5->Eval(sqrt(bmcpx*bmcpx+bmcpy*bmcpy)); }
else if(bmcrap<0.1) { weight = levyfit4->Eval(sqrt(bmcpx*bmcpx+bmcpy*bmcpy)); }
else if(bmcrap<0.3) { weight = levyfit5->Eval(sqrt(bmcpx*bmcpx+bmcpy*bmcpy)); }
else if(bmcrap<0.5) { weight = levyfit6->Eval(sqrt(bmcpx*bmcpx+bmcpy*bmcpy)); }
else if(bmcrap<0.7) { weight = levyfit7->Eval(sqrt(bmcpx*bmcpx+bmcpy*bmcpy)); }
...
*/
     ...
     h_mass_pt_fine_wgt->Fill(bparticlemass,brap,bpt,weight);
     h_mass_pt_fine2_wgt->Fill(bparticlemass,brap,bpt,weight);
     h_r_mass_pt_fine2_wgt->Fill(bparticlemass,-brap,bpt,weight);
...
g_r_pl_mc->Fill(bmcpl,ld_pl-bmcpl);

g_px_mc->Fill(bpx-bmcpx);
g_py_mc->Fill(bpy-bmcpy);
g_pz_mc->Fill(bpz-bmcpz);
//cout<<"bx:"<<bx<<" "<<bmcx<<endl;
cout<<"bz:"<<bz<<" "<<bmcz<<endl;
g_x_mc->Fill(bx-bmcx);
g_y_mc->Fill(by-bmcy);
g_z_mc->Fill(bz-bmcz);

g_z_eta_mc->Fill(bz-bmcz,beta);
}
...
for (Long64_t iEntry = 0; iEntry<=n_ks_mc_Entries; iEntry++){

                 ks_mc_tree.GetEntry(iEntry);
           if(iEntry%100000==0){
...
*/
     ...
     float pt_weight;
     pt_weight = levyfit4->Eval(bpt);

     weight = rap_weight*pt_weight;
     weight = 1;
/*
     if(brap<-0.7){ weight = levyfit8->Eval(bpt); }
     else if(brap<-0.5){ weight = levyfit7->Eval(bpt); }
     else if(brap<-0.3){ weight = levyfit6->Eval(bpt); }
     else if(brap<-0.1){ weight = levyfit5->Eval(bpt); }
     else if(brap<0.1) { weight = levyfit4->Eval(bpt); }
     else if(brap<0.3) { weight = levyfit5->Eval(bpt); }
     else if(brap<0.5) { weight = levyfit6->Eval(bpt); }
     else if(brap<0.7) { weight = levyfit7->Eval(bpt); }
     else { weight = levyfit8->Eval(bpt); }
*/
     weight *= mc_weight;
	...
	g_pt_fine_wgt->Fill(brap,bpt,weight);
        ...
        g_r_pt_fine2_wgt->Fill(-brap,bpt,weight);
...
void book_histo()
{
  ...
  h_mass_pt = new TH3F("h_mass_pt","",1000,0,1,9,-0.9,0.9,50,0,5);
  h_mass_pt_fine = new TH3F("h_mass_pt_fine","",1000,0,1,100,-1.0,1.0,50,0,5);
  h_mass_pt_fine2 = new TH3F("h_mass_pt_fine2","",1000,0,1,20,-1.0,1.0,50,0,5);
  h_r_mass_pt_fine2 = new TH3F("h_r_mass_pt_fine2","",1000,0,1,20,-1.0,1.0,50,0,5);
  h_mass_pl = new TH3F("h_mass_pl","",1000,0,1,9,-0.9,0.9,500,0,100);

  h_mass_pt_wgt = new TH3F("h_mass_pt_wgt","",1000,0,1,9,-0.9,0.9,50,0,5);
  h_mass_pt_fine_wgt = new TH3F("h_mass_pt_fine_wgt","",1000,0,1,100,-1.0,1.0,50,0,5);
  h_mass_pt_fine2_wgt = new TH3F("h_mass_pt_fine2_wgt","",1000,0,1,20,-1.0,1.0,50,0,5);
  h_r_mass_pt_fine2_wgt = new TH3F("h_r_mass_pt_fine2_wgt","",1000,0,1,20,-1.0,1.0,50,0,5);
  h_mass_pl_wgt = new TH3F("h_mass_pl_wgt","",1000,0,1,9,-0.9,0.9,500,0,100);

  h_mass_qa = new TH3F("h_mass_qa","",10,-2.0,0.0,50,0,5,1000,0,1);
  ...
  g_r_pt_fine2 = new TH2F("g_r_pt_fine2","",20,-1.0,1.0,50,0,5);

  g_pt_fine_wgt = new TH2F("g_pt_fine_wgt","",100,-1.0,1.0,50,0,5);
  g_pt_fine2_wgt = new TH2F("g_pt_fine2_wgt","",20,-1.0,1.0,50,0,5);
  g_r_pt_fine2_wgt = new TH2F("g_r_pt_fine2_wgt","",20,-1.0,1.0,50,0,5);
  ...
  g_r_pl_mc = new TH2F("g_r_pl_mc","",1000,0,100,1000,-100,100);

  g_px_mc = new TH1F("g_px_mc","",1000,-1,1);
  g_py_mc = new TH1F("g_py_mc","",1000,-1,1);
  g_pz_mc = new TH1F("g_pz_mc","",1000,-1,1);
  g_x_mc = new TH1F("g_x_mc","",1000,-5,5);
  g_y_mc = new TH1F("g_y_mc","",1000,-5,5);
  g_z_mc = new TH1F("g_z_mc","",1000,-5,5);

  g_z_eta_mc = new TH2F("g_z_eta_mc","",1000,-5,5,100,-2,0);
  ...
  h_mass_pt->Sumw2();
  h_mass_pt_fine->Sumw2();
  h_mass_pt_fine2->Sumw2();
  h_r_mass_pt_fine2->Sumw2();
  
  h_mass_pt_wgt->Sumw2();
  h_mass_pt_fine_wgt->Sumw2();
  h_mass_pt_fine2_wgt->Sumw2();
  h_r_mass_pt_fine2_wgt->Sumw2();
...
h_mass_pt_fine->Write();

g_pt_fine2_wgt->Write();
g_r_pt_fine2_wgt->Write();
g_pt_fine2->Write();
g_r_pt_fine2->Write();
h_mass_pt_fine2_wgt->Write();
h_r_mass_pt_fine2_wgt->Write();
h_mass_pt_fine2->Write();
h_r_mass_pt_fine2->Write();
