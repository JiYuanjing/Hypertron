...
void process_tree_tmva_hl_kf_vmv15_chenlu(int condor=0, int cut_mode=2, int wgt=4, int batch=0, int cut_0=0, int cut_1=0, int cut_2=0, int cut_3=0, int cut_4=2){
...
strcpy (ofile, Form("run18_3gev_hl_hist_mu_1x_8_newreweight_centa%d_wgt%d_cut%d_%d%d%d%d%d_mve_nohepid_vmv15.root",choose_cent,_wgt,_cut_mode,_cut_0,_cut_1,_cut_2,_cut_3,_cut_4));
nChains = 1267;
...
strcpy (ofile,Form("run18_3gev_hl_hist_pico_centa%d_cut%d_%d%d%d%d%d_v15cl.root",choose_cent,_cut_mode,_cut_0,_cut_1,_cut_2,_cut_3,_cut_4));
nChains = 1225;
}
        if(_batch==1){
fin.open("/star/u/yhleung2/pwg/33.standard_reco/taxi_ht_pico_tree_newdata_rotate_0/filelist.txt");
strcpy (ofile,Form("run18_3gev_hl_hist_pico_rotate_0_centa%d_cut%d_%d%d%d%d%d_v15cl.root",choose_cent,_cut_mode,_cut_0,_cut_1,_cut_2,_cut_3,_cut_4));
nChains = 1225;
}
        if(_batch==2){
fin.open("/star/u/yhleung2/pwg/33.standard_reco/taxi_ht_pico_tree_newdata_rotate_1/filelist.txt");
strcpy (ofile,Form("run18_3gev_hl_hist_pico_rotate_1_centa%d_cut%d_%d%d%d%d%d_v15cl.root",choose_cent,_cut_mode,_cut_0,_cut_1,_cut_2,_cut_3,_cut_4));
nChains = 1221;
}
        if(_batch==3){
fin.open("/star/u/yhleung2/pwg/33.standard_reco/taxi_ht_pico_tree_newdata_rotate_2/filelist.txt");
strcpy (ofile,Form("run18_3gev_hl_hist_pico_rotate_2_centa%d_cut%d_%d%d%d%d%d_v15cl.root",choose_cent,_cut_mode,_cut_0,_cut_1,_cut_2,_cut_3,_cut_4));
nChains = 1225;
}
        if(_batch==4){
fin.open("/star/u/yhleung2/pwg/33.standard_reco/taxi_ht_pico_tree_newdata_rotate_3/filelist.txt");
strcpy (ofile,Form("run18_3gev_hl_hist_pico_rotate_3_centa%d_cut%d_%d%d%d%d%d_v15cl.root",choose_cent,_cut_mode,_cut_0,_cut_1,_cut_2,_cut_3,_cut_4));
nChains = 1225;
}
        if(_batch==5){
fin.open("/star/u/yhleung2/pwg/33.standard_reco/taxi_ht_pico_tree_newdata_rotate_4/filelist.txt");
strcpy (ofile,Form("run18_3gev_hl_hist_pico_rotate_4_centa%d_cut%d_%d%d%d%d%d_v15cl.root",choose_cent,_cut_mode,_cut_0,_cut_1,_cut_2,_cut_3,_cut_4));
nChains = 1225;
}
if(_batch==6){
fin.open("/star/u/yhleung2/pwg/33.standard_reco/taxi_ht_pico_tree_newdata_rotate_5/filelist.txt");
strcpy (ofile,Form("run18_3gev_hl_hist_pico_rotate_5_centa%d_cut%d_%d%d%d%d%d_v15cl.root",choose_cent,_cut_mode,_cut_0,_cut_1,_cut_2,_cut_3,_cut_4));
nChains = 1225;
}
if(_batch==7){
fin.open("/star/u/yhleung2/pwg/33.standard_reco/taxi_ht_pico_tree_newdata_rotate_6/filelist.txt");
strcpy (ofile,Form("run18_3gev_hl_hist_pico_rotate_6_centa%d_cut%d_%d%d%d%d%d_v15cl.root",choose_cent,_cut_mode,_cut_0,_cut_1,_cut_2,_cut_3,_cut_4));
nChains = 1225;
}
...
//
//chenlu fidicial
if(brap>0.8) continue;
if(brap<0.2) continue;
if(bpt>3) continue;
if(bpt<1.2) continue;
...
//	if(atanh(pz_he/sqrt(px_he*px_he+py_he*py_he+pz_he*pz_he))>-0.3) continue;
  ...
  h_mass_pt = new TH3F("h_mass_pt","",1000,min_mass,max_mass,100,-1.0,1.0,50,0,5);
  ...
  h_mass_pt_wgt = new TH3F("h_mass_pt_wgt","",1000,min_mass,max_mass,100,-1.0,1.0,50,0,5);
