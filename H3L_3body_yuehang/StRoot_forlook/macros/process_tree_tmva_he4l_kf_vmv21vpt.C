...
//void process_tree_tmva_he4l_kf_vmv21vpt(int condor=0, int cut_mode=2, int wgt=4, int batch=0, int cut_0=0, int cut_1=0, int cut_2=0, int cut_3=0, int cut_4=2,int _choose_cent = 0){
void process_tree_tmva_he4l_kf_vmv21vpt(int condor=1, int cut_mode=2, int wgt=0, int batch=1, int cut_0=0, int cut_1=0, int cut_2=0, int cut_3=0, int cut_4=2,int _choose_cent = 0){
...
//fin.open("/star/u/yhleung2/pwg/33.standard_reco/taxi_he4l_mu_tree/filelist.txt");
strcpy (ofile, Form("run18_3gev_he4l_hist_mu_centa%d_wgt%d_cut%d_%d%d%d%d%d_vmv21vpt.root",choose_cent,_wgt,_cut_mode,_cut_0,_cut_1,_cut_2,_cut_3,_cut_4));
//nChains = 27;

fin.open("/star/u/yhleung2/pwg/33.standard_reco/taxi_he4l_mu_tree_off/filelist.txt");
nChains = 114;
...
if(_condor==1){//data
        ...
        if(_batch==0){
fin.open("/star/u/yhleung2/pwg/33.standard_reco/taxi_he4l_pico_tree/filelist.txt");
strcpy (ofile,Form("run18_3gev_he4l_hist_pico_centa%d_cut%d_%d%d%d%d%d_v21vpt_codata.root",choose_cent,_cut_mode,_cut_0,_cut_1,_cut_2,_cut_3,_cut_4));
nChains = 1212;
//nChains = 10;
}

        if(_batch==1){
fin.open("/star/u/yhleung2/pwg/33.standard_reco/taxi_he4l_pico_rotate_tree/filelist.txt");
strcpy (ofile,Form("run18_3gev_he4l_hist_pico_rotate_0_centa%d_cut%d_%d%d%d%d%d_v21vpt_codata.root",choose_cent,_cut_mode,_cut_0,_cut_1,_cut_2,_cut_3,_cut_4));
nChains = 1184;
}

        if(_batch==2){
fin.open("/star/u/yhleung2/pwg/33.standard_reco/taxi_he4l_pico_rotate_tree_1/filelist.txt");
strcpy (ofile,Form("run18_3gev_he4l_hist_pico_rotate_1_centa%d_cut%d_%d%d%d%d%d_v21vpt_codata.root",choose_cent,_cut_mode,_cut_0,_cut_1,_cut_2,_cut_3,_cut_4));
nChains = 1212;
}
        if(_batch==3){
fin.open("/star/u/yhleung2/pwg/33.standard_reco/taxi_he4l_pico_rotate_tree_2/filelist.txt");
strcpy (ofile,Form("run18_3gev_he4l_hist_pico_rotate_2_centa%d_cut%d_%d%d%d%d%d_v21vpt_codata.root",choose_cent,_cut_mode,_cut_0,_cut_1,_cut_2,_cut_3,_cut_4));
nChains = 1204;
}
        if(_batch==4){
fin.open("/star/u/yhleung2/pwg/33.standard_reco/taxi_he4l_pico_rotate_tree_3/filelist.txt");
strcpy (ofile,Form("run18_3gev_he4l_hist_pico_rotate_3_centa%d_cut%d_%d%d%d%d%d_v21vpt_codata.root",choose_cent,_cut_mode,_cut_0,_cut_1,_cut_2,_cut_3,_cut_4));
nChains = 1199;
}
        if(_batch==5){
fin.open("/star/u/yhleung2/pwg/33.standard_reco/taxi_he4l_pico_rotate_tree_4/filelist.txt");
strcpy (ofile,Form("run18_3gev_he4l_hist_pico_rotate_4_centa%d_cut%d_%d%d%d%d%d_v21vpt_codata.root",choose_cent,_cut_mode,_cut_0,_cut_1,_cut_2,_cut_3,_cut_4));
nChains = 1204;
}
/*
if(_batch==6){
...
if(bparticleid==3006 && ((bismc==1&&_condor==0) || _condor==1 || _condor==2) ){
...
//	weight *=pl_weight;
	...
	if(bparticleid==3006 && (bismc==1&&_condor==0)){
//		if(bparticlemass>mass_lo && bparticlemass<mass_hi){//this is not neccesarry for mc tracks
	...
	if(bmcparticleid!=3006) continue;
...
int nhistrapbins = 8;
  ...
  h_mass_qa_2 = new TH2F("h_mass_qa_2","",2000,min_mass-1,max_mass,2000,min_mass-1,max_mass);
	...
	h_mass_0102 = new TH2F("h_mass_0102","",500,0.5,1.5,500,2.5,3.5);
