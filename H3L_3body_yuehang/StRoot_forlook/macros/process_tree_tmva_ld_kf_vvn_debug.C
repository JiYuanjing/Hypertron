...
void process_tree_tmva_ld_kf_vvn_debug(int condor=0, int cut_mode=0){
...
//fin.open("/star/u/yhleung2/pwg/33.standard_reco/taxi_ld_mu3_loose_vn_eff/filelist.txt");
//strcpy (ofile, Form("run18_3gev_ld_hist_mu_1x_vn_newreweight_centa%d_cut%d.root",choose_cent,_cut_mode));
//nChains = 968;
...
fin.open("/star/u/yhleung2/pwg/33.standard_reco/filelist_debug.txt");
strcpy (ofile, Form("run18_3gev_ld_hist_mu_1x_vn_newreweight_centa%d_cut%d_debug.root",choose_cent,_cut_mode));
nChains = 1;
...
if(_cut_mode==2 || _cut_mode==11 || _cut_mode==12){
ld_chi2topo_cut = 5;
ld_chi2ndf_cut = 5;
ld_ldl_cut = 5;
ld_l_cut = 1;
...
*/
  ...
  h_mass_pt_fine_wgt->Fill(bparticlemass,bmcrap,sqrt(bmcpx*bmcpx+bmcpy*bmcpy));
//     h_mass_pt_fine_wgt->Fill(bparticlemass,brap,bpt);
...
void book_histo()
{
  ...
  h_mass_pt_fine_wgt = new TH3F("h_mass_pt_fine_wgt","",1000,1,2,20,-0.8,1.2,15,0,3);
  h_mass_pt_fine2_wgt = new TH3F("h_mass_pt_fine2_wgt","",1000,1,2,20,-0.8,1.2,15,0,3);
  ...
  g_pt_fine_wgt = new TH2F("g_pt_fine_wgt","",  20,-0.8,1.2,15,0,3);
  g_pt_fine2_wgt = new TH2F("g_pt_fine2_wgt","",20,-0.8,1.2,15,0,3);
