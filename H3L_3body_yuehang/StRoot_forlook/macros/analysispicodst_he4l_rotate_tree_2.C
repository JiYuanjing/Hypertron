...
*/
bool _isPico;
void analysispicodst_he4l_rotate_tree_2(TString picolist="test.list",  TString outFileName="test27gev1.root", bool _isPico=true)
{
...
//  StKFParticleInterface::instance()->AddDecayToReconstructionList(-3334);
    ...
    StKFParticleInterface::instance()->SetRotationAngle(TMath::Pi()*1.5);
