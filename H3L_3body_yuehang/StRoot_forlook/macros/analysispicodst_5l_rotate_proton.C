...
*/
bool _isPico;
void analysispicodst_5l_rotate_proton(TString picolist="test.list",  TString outFileName="test27gev1.root", bool _isPico=true)
{
...
StKFParticleInterface::instance()->SetRotation();
  StKFParticleInterface::instance()->SetRotationAngle(TMath::Pi());
      StKFParticleInterface::instance()->SetRotationPID(2212);//pi minus
