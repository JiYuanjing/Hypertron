...
void process_tree_tmva_hl_kf_vmv15(int condor=0, int cut_mode=2, int wgt=4, int batch=0, int cut_0=0, int cut_1=0, int cut_2=0, int cut_3=0, int cut_4=2){
...
strcpy (ofile,Form("run18_3gev_hl_hist_pico_centa%d_cut%d_%d%d%d%d%d_v15.root",choose_cent,_cut_mode,_cut_0,_cut_1,_cut_2,_cut_3,_cut_4));
nChains = 1225;
}
        if(_batch==1){
fin.open("/star/u/yhleung2/pwg/33.standard_reco/taxi_ht_pico_tree_newdata_rotate_0/filelist.txt");
strcpy (ofile,Form("run18_3gev_hl_hist_pico_rotate_0_centa%d_cut%d_%d%d%d%d%d_v15.root",choose_cent,_cut_mode,_cut_0,_cut_1,_cut_2,_cut_3,_cut_4));
nChains = 1225;
}
        if(_batch==2){
fin.open("/star/u/yhleung2/pwg/33.standard_reco/taxi_ht_pico_tree_newdata_rotate_1/filelist.txt");
strcpy (ofile,Form("run18_3gev_hl_hist_pico_rotate_1_centa%d_cut%d_%d%d%d%d%d_v15.root",choose_cent,_cut_mode,_cut_0,_cut_1,_cut_2,_cut_3,_cut_4));
nChains = 1221;
}
        if(_batch==3){
fin.open("/star/u/yhleung2/pwg/33.standard_reco/taxi_ht_pico_tree_newdata_rotate_2/filelist.txt");
strcpy (ofile,Form("run18_3gev_hl_hist_pico_rotate_2_centa%d_cut%d_%d%d%d%d%d_v15.root",choose_cent,_cut_mode,_cut_0,_cut_1,_cut_2,_cut_3,_cut_4));
nChains = 1225;
}
        if(_batch==4){
fin.open("/star/u/yhleung2/pwg/33.standard_reco/taxi_ht_pico_tree_newdata_rotate_3/filelist.txt");
strcpy (ofile,Form("run18_3gev_hl_hist_pico_rotate_3_centa%d_cut%d_%d%d%d%d%d_v15.root",choose_cent,_cut_mode,_cut_0,_cut_1,_cut_2,_cut_3,_cut_4));
nChains = 1225;
}
        if(_batch==5){
fin.open("/star/u/yhleung2/pwg/33.standard_reco/taxi_ht_pico_tree_newdata_rotate_4/filelist.txt");
strcpy (ofile,Form("run18_3gev_hl_hist_pico_rotate_4_centa%d_cut%d_%d%d%d%d%d_v15.root",choose_cent,_cut_mode,_cut_0,_cut_1,_cut_2,_cut_3,_cut_4));
nChains = 1225;
}
if(_batch==6){
fin.open("/star/u/yhleung2/pwg/33.standard_reco/taxi_ht_pico_tree_newdata_rotate_5/filelist.txt");
strcpy (ofile,Form("run18_3gev_hl_hist_pico_rotate_5_centa%d_cut%d_%d%d%d%d%d_v15.root",choose_cent,_cut_mode,_cut_0,_cut_1,_cut_2,_cut_3,_cut_4));
nChains = 1225;
}
if(_batch==7){
fin.open("/star/u/yhleung2/pwg/33.standard_reco/taxi_ht_pico_tree_newdata_rotate_6/filelist.txt");
strcpy (ofile,Form("run18_3gev_hl_hist_pico_rotate_6_centa%d_cut%d_%d%d%d%d%d_v15.root",choose_cent,_cut_mode,_cut_0,_cut_1,_cut_2,_cut_3,_cut_4));
nChains = 1225;
}
