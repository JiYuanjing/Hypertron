...
void process_tree_tmva_3b_kf_vmv11(int condor=0, int cut_mode=0, int wgt=2, int batch=0){
...
fin.open("/star/u/yhleung2/pwg/33.standard_reco/taxi_3b_mu_manualvtxerr_new_2/filelist.txt");
//strcpy (ofile, Form("run18_3gev_3b_hist_mu_1x_30_newreweight_centa%d_wgt%d_cut%d_mve.root",choose_cent,_wgt,_cut_mode));

strcpy (ofile, Form("run18_3gev_3b_hist_mu_1x_41b_newreweight_centa%d_wgt%d_cut%d_mve.root",choose_cent,_wgt,_cut_mode));
...
//        strcpy (ofile,Form("run18_3gev_3b_hist_pico_bdt_26_centa%d_cut%d.root",choose_cent,_cut_mode));//12: new finder
	...
	//strcpy (ofile,Form("run18_3gev_3b_hist_pico_bdt_33_centa%d_cut%d.root",choose_cent,_cut_mode));//30:onesided, 31:1sigma, 32: no cut
	        strcpy (ofile,Form("run18_3gev_3b_hist_pico_bdt_44_centa%d_cut%d.root",choose_cent,_cut_mode));//30:onesided, 31:1sigma, 32: no cut//30b onesided, fix the weighting, 34:no cut, ptcut
	      nChains = 1197;
...
fin.open("/star/u/yhleung2/pwg/33.standard_reco/taxi_3b_pico_rotate_tree_deuteron/filelist.txt");
        strcpy (ofile,Form("run18_3gev_3b_hist_pico_rotate_0_bdt_44_centa%d_cut%d.root",choose_cent,_cut_mode));//40 no pt cut
      nChains = 1207;
