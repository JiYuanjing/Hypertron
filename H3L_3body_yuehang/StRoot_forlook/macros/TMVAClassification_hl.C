...
void TMVAClassification_hl( int const ptBin = 0,
//               int const centBin = 0,
            TString myMethodList = "" )
{
  ...
  float const PtBins[nPtBins+1] =    {2.0,50.0};
   ...
   // Create a ROOT output file where TMVA will store ntuples, histograms, etc.
    ...
    TFile* outputFile = TFile::Open( Form("output/TMVA_om_hl_pl_wgt_%d.root",ptBin), "RECREATE" );
   ...
   TString weightBaseName = Form("tmva_hl_weight_kf_pt_%d",ptBin);
...
//   Chi2NDF:LdL:Chi2Topo:refMult:motherMass:motherPt:motherEta                           31
   ...
   // TTree *background = (TTree*)background_file->Get("D0");
    ...
    char name[250];
    sprintf(name,"run18_3gev_tmva_hl_sig.root");
    ...
    //sideband
    sprintf(name,"run18_3gev_tmva_hl_bkg.root");
...
factory->PrepareTrainingAndTestTree( mycut, 20000, 20000, 20000, 20000,
  ...
  //                                   "nTrain_Signal=0:nTrain_Background=0:SplitMode=Random:NormMode=NumEvents:!V" );
   ...
   if (Use["Cuts"])
      factory->BookMethod( TMVA::Types::kCuts, "Cuts",
                           "!H:!V:FitMethod=MC:EffSel:SampleSize=100000000:VarProp=FSmart" );
