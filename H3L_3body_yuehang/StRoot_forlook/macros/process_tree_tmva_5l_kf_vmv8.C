...
void process_tree_tmva_5l_kf_vmv8(int condor=0, int cut_mode=0, int wgt=2, int batch=0){
...
strcpy (ofile, Form("run18_3gev_3b_hist_mu_1x_26_newreweight_centa%d_wgt%d_cut%d_mve.root",choose_cent,_wgt,_cut_mode));
nChains = 255;
}
if(_condor==1){//data
...
//   	strcpy (ofile,Form("run18_3gev_3b_hist_pico_bdt_11_centa%d_cut%d.root",choose_cent,_cut_mode));
        ...
        //strcpy (ofile,Form("run18_3gev_3b_hist_pico_bdt_22_centa%d_cut%d.root",choose_cent,_cut_mode));//12: new finder
        strcpy (ofile,Form("run18_3gev_3b_hist_pico_bdt_25_centa%d_cut%d.root",choose_cent,_cut_mode));//12: new finder
        
	//fin.open("/star/u/yhleung2/pwg/33.standard_reco/taxi_5l_pico_tree_new_tfg/filelist.txt");
	//strcpy (ofile,Form("run18_3gev_5l_hist_pico_bdt_24_centa%d_cut%d_all.root",choose_cent,_cut_mode));
	nChains = 1171;
   	}
	if(_batch==1){
...
//	fin.open("/star/u/yhleung2/pwg/33.standard_reco/taxi_3b_pico_rotate_tree_0_0_0/filelist.txt");//modified kfparticlefinder
	fin.open("/star/u/yhleung2/pwg/33.standard_reco/taxi_3b_pico_rotate_tree_0_0_0_rotate_pion/filelist.txt");//modified kfparticlefinder
//        strcpy (ofile,Form("run18_3gev_3b_hist_pico_rotate_0_bdt_21_centa%d_cut%d.root",choose_cent,_cut_mode));
        //strcpy (ofile,Form("run18_3gev_3b_hist_pico_rotate_0_bdt_22_centa%d_cut%d.root",choose_cent,_cut_mode));
        //strcpy (ofile,Form("run18_3gev_3b_hist_pico_rotate_0_bdt_23_centa%d_cut%d.root",choose_cent,_cut_mode));//low mass cut
        //strcpy (ofile,Form("run18_3gev_3b_hist_pico_rotate_0_bdt_24_centa%d_cut%d.root",choose_cent,_cut_mode));//low mass cut, rotate pion
        strcpy (ofile,Form("run18_3gev_3b_hist_pico_rotate_0_bdt_25_centa%d_cut%d.root",choose_cent,_cut_mode));//reverse low mass cut, rotate pion

//	fin.open("/star/u/yhleung2/pwg/33.standard_reco/taxi_5l_pico_rotate_tree_tfg/filelist.txt");
//	        strcpy (ofile,Form("run18_3gev_5l_hist_pico_rotate_bdt_24_centa%d_cut%d_all.root",choose_cent,_cut_mode));

	        nChains = 1071;
//	        nChains = 1222;
	}
	if(_batch==2){
	fin.open("/star/u/yhleung2/pwg/33.standard_reco/taxi_3b_pico_rotate_tree_0_0_1/filelist.txt");
        strcpy (ofile,Form("run18_3gev_3b_hist_pico_rotate_1_bdt_21_centa%d_cut%d.root",choose_cent,_cut_mode));
	}
        if(_batch==3){
	fin.open("/star/u/yhleung2/pwg/33.standard_reco/taxi_3b_pico_rotate_tree_0_0_2/filelist.txt");
        strcpy (ofile,Form("run18_3gev_3b_hist_pico_rotate_2_bdt_21_centa%d_cut%d.root",choose_cent,_cut_mode));
	}
        if(_batch==4){
...
TLorentzVector ptc_deuteron(bdpx,bdpy,bdpz,sqrt(bdpx*bdpx+bdpy*bdpy+bdpz*bdpz+1.8756*1.8756));
TLorentzVector ptc_lambda = ptc_pion + ptc_proton;
TLorentzVector ptc_mother = ptc_pion + ptc_proton + ptc_deuteron;

TLorentzVector ptc_fake(bpionpx+bprotonpx,bpionpy+bprotonpy,bpionpz+bprotonpz,sqrt((bpionpx+bprotonpx)*(bpionpx+bprotonpx)+(bpionpy+bprotonpy)*(bpionpy+bprotonpy)+(bpionpz+bprotonpz)*(bpionpz+bprotonpz)+1.11568*1.11568));
TLorentzVector ptc_mother_lambda = ptc_fake + ptc_deuteron;
...
//fiducial cut
	...
	//h_mass_qa->Fill(beta,bpt,ptc_mother.M());
	//h_mass_qa->Fill(beta,bpt,ptc_mother_lambda.M());
