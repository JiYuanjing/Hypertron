...
void process_tree_tmva_hl_kf_vmv14(int condor=0, int cut_mode=2, int wgt=4, int batch=0, int cut_0=0, int cut_1=0, int cut_2=0, int cut_3=0, int cut_4=2){
...
//strcpy (ofile, Form("run18_3gev_hl_hist_mu_1x_8_newreweight_centa%d_wgt%d_cut%d_%d%d%d%d%d_mve_vmv14.root",choose_cent,_wgt,_cut_mode,_cut_0,_cut_1,_cut_2,_cut_3,_cut_4));
//nChains = 1268;
