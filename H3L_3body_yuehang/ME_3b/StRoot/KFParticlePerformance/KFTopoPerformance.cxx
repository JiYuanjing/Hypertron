...
void KFTopoPerformance::GetMCParticles()
{
  ...
  for(unsigned int iMC=0; iMC < vMCTracks.size(); iMC++)
  {
    ...
    // cout<<"kftrack pdg:  " << mtra.PDG()<< endl;
  }
...
//FOR HT3body only
          if( part.GetPDG()==211 && vMCParticles[iMC].GetMotherId()==-1 && part.GetDaughterIds().size()==3){
            	...
            	// cout<<"vMCParticles[part.GetDaughterIds()[0]].GetPDG():"<<
              //   vMCParticles[part.GetDaughterIds()[0]].GetPDG()<<" "
              //   <<vMCParticles[part.GetDaughterIds()[1]].GetPDG()<<" "
              //   <<vMCParticles[part.GetDaughterIds()[2]].GetPDG()<<endl;
