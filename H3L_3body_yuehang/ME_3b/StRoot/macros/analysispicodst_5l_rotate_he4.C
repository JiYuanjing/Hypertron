...
*/
bool _isPico;
void analysispicodst_5l_rotate_he4(TString picolist="test.list",  TString outFileName="test27gev1.root", bool _isPico=true)
{
...
//  StKFParticleInterface::instance()->AddDecayToReconstructionList( 103004);
  ...
  StKFParticleInterface::instance()->AddDecayToReconstructionList( 3007);
...
StKFParticleInterface::instance()->SetRotation();
  StKFParticleInterface::instance()->SetRotationAngle(TMath::Pi());
      StKFParticleInterface::instance()->SetRotationPID(1000020040);//pi minus
