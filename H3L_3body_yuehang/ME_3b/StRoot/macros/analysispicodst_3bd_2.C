...
*/
bool _isPico;
void analysispicodst_3bd_2(TString picolist="test.list",  TString outFileName="test27gev1.root", bool _isPico=true)
{
...
StKFParticleInterface::instance()->SetChi2CutCharmManybodyDecays(10);
	...
	StKFParticleInterface::instance()->SetChi2CutXiOmega(15);
...
//  StKFParticleInterface::instance()->AddDecayToReconstructionList(-3334);
  ...
  StKFParticleInterface::instance()->AddDecayToReconstructionList( 3122);//lambda0  
  StKFParticleInterface::instance()->AddDecayToReconstructionList( 103005);
