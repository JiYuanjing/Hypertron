...
#endif
  for(unsigned int iParticle=0; iParticle<fParticles.size(); iParticle++)
    if(deleteCandidate[iParticle] &&  fParticles[iParticle].GetPDG()!=2212  && fParticles[iParticle].GetPDG()!=-211 && abs(fParticles[iParticle].GetPDG())!=3012 && abs(fParticles[iParticle].GetPDG())!=1000010020)
