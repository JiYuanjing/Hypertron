 ...
 // if (mode==1) fgpt_0 = new TFile("ld_input_mc_fine_v20.root","READ");//more stats
  ...
  for (int i=0;i<n_Entries;i++)
  {
    ...
    if (mode==0 ) {
      ...
      //default cut
      // double lcut=8, ldlcut=5, chi2topocut = 1.5, pdcut=3, ppcut=2, chi2ndfcut=3.5, chi2_dcut=0, chi2_picut=10, chi2_pcut=5;
      // double lcut=8, ldlcut=5, chi2topocut = 2.5, pdcut=3, ppcut=2, chi2ndfcut=3.5, chi2_dcut=0, chi2_picut=10, chi2_pcut=5;
