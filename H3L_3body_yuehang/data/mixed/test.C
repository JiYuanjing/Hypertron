void test()
{
  ...
  //
  // t->Draw("dca_deuteron"," bparticlemass<3.2 && bparticlemass>2.95 && mass_01 <1.15 && mass_01>1. && (bpx*bpx+bpy*bpy)<0.25&& bisMix==0");
  // t->Draw("dca_deuteron2","bparticlemass<3.2 && bparticlemass>2.95 && mass_01 <1.15 && mass_01>1.&& (bpx*bpx+bpy*bpy)<0.25 && bisMix==0","same");
  ...
  // t2->Draw("dca_deuteron","bparticlemass<3.2 && bparticlemass>2.95 && mass_01 <1.15 && mass_01>1.");
  // t2->Draw("dca_deuteron2","bparticlemass<3.2 && bparticlemass>2.95 && mass_01 <1.15 && mass_01>1.","same");
}
